...
const getOrbs = (variant: AuraVariant, isDark: boolean, width: number, height: number): OrbConfig[] => {
  ...
  switch (variant) {
    case 'login':
      return [
        { color: '#4F6DF5', cx: width * 0.2, cy: height * 0.25, r: '45%', opacity: alpha * 1.4 },
        { color: '#9B5DE5', cx: width * 0.8, cy: height * 0.45, r: '40%', opacity: alpha * 1.2 },
        { color: '#F15BB5', cx: width * 0.4, cy: height * 0.8, r: '35%', opacity: alpha },
      ];
    case 'chat':
      return [
        { color: '#4F6DF5', cx: width * 0.85, cy: height * 0.08, r: '40%', opacity: alpha * 0.8 },
        { color: '#9B5DE5', cx: width * 0.1, cy: height * 0.85, r: '38%', opacity: alpha * 0.7 },
      ];
    default:
      return [
        { color: '#4F6DF5', cx: width * 0.15, cy: height * 0.15, r: '42%', opacity: alpha },
        { color: '#9B5DE5', cx: width * 0.85, cy: height * 0.5, r: '38%', opacity: alpha * 0.9 },
        { color: '#F15BB5', cx: width * 0.45, cy: height * 0.9, r: '35%', opacity: alpha * 0.7 },
      ];
  }
};
