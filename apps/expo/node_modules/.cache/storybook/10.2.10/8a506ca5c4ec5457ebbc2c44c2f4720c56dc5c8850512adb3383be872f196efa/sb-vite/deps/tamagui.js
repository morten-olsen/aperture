...
import {
  ...
  TextInput_default,
  View_default
} from "./chunk-PAQUUFBS.js";
import {
  require_jsx_runtime
} from "./chunk-ZD2TE45S.js";
import "./chunk-FJNLLE7A.js";
import {
  require_react_dom
} from "./chunk-HT6CVLZN.js";
import {
  require_react
} from "./chunk-7Y7B3ADK.js";
import {
  __toESM
...
var PresenceChild = React4.memo(({
  ...
  const presenceChildren = useConstant(newChildrenMap), id = (0, import_react3.useId)() || "", context2 = React4.useMemo(
    () => ({
      id,
      initial,
      isPresent: isPresent2,
  ...
  }, [isPresent2]), (0, import_jsx_runtime.jsx)(PresenceContext.Provider, {
    value: context2,
    children
  });
});
...
var AnimatePresence = ({
  ...
  if (passThrough) return (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, {
    children
  });
  if (useIsomorphicLayoutEffect(() => {
    isInitialRender.current = false;
  }, []), isInitialRender.current) return (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, {
...
var startTransition = (callback) => {
  (0, import_react5.startTransition)(callback);
};
...
function useControllableState({
  ...
  const [state, setState] = React5.useState(prop ?? defaultProp), previous = React5.useRef(state), propWins = strategy === "prop-wins" && prop !== void 0, value = propWins ? prop : state, onChangeCb = useEvent(onChange || idFn2), transitionFn = transition ? startTransition : emptyCallbackFn;
  React5.useEffect(() => {
    prop !== void 0 && (previous.current = prop, transitionFn(() => {
      setState(prop);
    }));
  }, [prop]), React5.useEffect(() => {
...
var _Collapsible = React6.forwardRef((props, forwardedRef) => {
  const {
    __scopeCollapsible,
    open: openProp,
    defaultOpen,
  ...
  return (0, import_jsx_runtime3.jsx)(CollapsibleProvider, {
    scope: __scopeCollapsible,
    disabled,
    contentId: React6.useId(),
    open,
    onOpenToggle: React6.useCallback(() => setOpen((prevOpen) => !prevOpen), [setOpen]),
    children: (0, import_jsx_runtime3.jsx)(Stack, {
...
var CollapsibleTrigger = CollapsibleTriggerFrame.styleable((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime3.jsx)(CollapsibleTriggerFrame, {
...
var CollapsibleContent = CollapsibleContentFrame.styleable((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime3.jsx)(AnimatePresence, {
    ...contentProps,
    children: forceMount || context2.open ? (0, import_jsx_runtime3.jsx)(CollapsibleContentFrame, {
      ref: forwardedRef,
      ...contentProps,
      children: (0, import_jsx_runtime3.jsx)(ResetPresence, {
        children
      })
    }) : null
  });
...
function createCollection(name) {
  ...
  }, "Toast"), CollectionProvider = (props) => {
    const {
      scope,
      children
    } = props, ref = import_react6.default.useRef(void 0), itemMap = import_react6.default.useRef(/* @__PURE__ */ new Map()).current;
    return (0, import_jsx_runtime4.jsx)(CollectionProviderImpl, {
      scope,
      itemMap,
      collectionRef: ref,
      children
  ...
  const COLLECTION_SLOT_NAME = name + "CollectionSlot", CollectionSlot = import_react6.default.forwardRef((props, forwardedRef) => {
    const {
      scope,
      children
    } = props, context2 = useCollectionContext(scope), composedRefs = useComposedRefs(forwardedRef, context2.collectionRef);
    return (0, import_jsx_runtime4.jsx)(Slot, {
      ref: composedRefs,
      children
    });
  });
  CollectionSlot.displayName = COLLECTION_SLOT_NAME;
  const ITEM_SLOT_NAME = name + "CollectionItemSlot", ITEM_DATA_ATTR = "data-collection-item", CollectionItemSlot = import_react6.default.forwardRef((props, forwardedRef) => {
    const {
      scope,
      children,
      ...itemData
    } = props, ref = import_react6.default.useRef(void 0), composedRefs = useComposedRefs(forwardedRef, ref), context2 = useCollectionContext(scope);
    return import_react6.default.useEffect(() => (context2.itemMap.set(ref, {
      ref,
      ...itemData
    }), () => void context2.itemMap.delete(ref))), (0, import_jsx_runtime4.jsx)(Slot, {
      [ITEM_DATA_ATTR]: "",
      ref: composedRefs,
      children
    });
  ...
  function useCollection3(scope) {
    ...
    return import_react6.default.useCallback(() => {
      if (!isWeb) return [];
...
var Paragraph = styled(SizableText2, {
  name: "Paragraph",
  tag: "p",
  userSelect: "auto",
  color: "$color",
...
var AccordionComponent = React11.forwardRef((props, forwardedRef) => {
  const {
    type,
    ...accordionProps
  } = props, singleProps = accordionProps, multipleProps = accordionProps;
  return (0, import_jsx_runtime7.jsx)(Collection.Provider, {
    scope: props.__scopeAccordion || ACCORDION_CONTEXT,
    children: type === "multiple" ? (0, import_jsx_runtime7.jsx)(AccordionImplMultiple, {
      ...multipleProps,
      ref: forwardedRef
    }) : (0, import_jsx_runtime7.jsx)(AccordionImplSingle, {
      ...singleProps,
      ref: forwardedRef
    })
  });
...
var AccordionImplSingle = React11.forwardRef((props, forwardedRef) => {
  const {
    value: valueProp,
    defaultValue,
    control,
  ...
  return (0, import_jsx_runtime7.jsx)(AccordionValueProvider, {
    scope: props.__scopeAccordion,
    value: value ? [value] : [],
    onItemOpen: setValue,
    onItemClose: React11.useCallback(() => collapsible && setValue(""), [setValue, collapsible]),
    children: (0, import_jsx_runtime7.jsx)(AccordionCollapsibleProvider, {
      scope: props.__scopeAccordion,
      collapsible,
      children: (0, import_jsx_runtime7.jsx)(AccordionImpl, {
        ...accordionSingleProps,
        ref: forwardedRef
      })
    })
...
var AccordionImplMultiple = React11.forwardRef((props, forwardedRef) => {
  const {
    value: valueProp,
    defaultValue,
    onValueChange = () => {
    ...
    defaultProp: defaultValue || [],
    onChange: onValueChange
  }), handleItemOpen = React11.useCallback((itemValue) => setValue((prevValue = []) => [...prevValue, itemValue]), [setValue]), handleItemClose = React11.useCallback((itemValue) => setValue((prevValue = []) => prevValue.filter((value2) => value2 !== itemValue)), [setValue]);
  return (0, import_jsx_runtime7.jsx)(AccordionValueProvider, {
    scope: props.__scopeAccordion,
    value: value || [],
...
var AccordionImpl = React11.forwardRef((props, forwardedRef) => {
  const {
    __scopeAccordion,
    disabled,
    dir,
    ...
    ...accordionProps
  } = props, accordionRef = React11.useRef(null), composedRef = useComposedRefs(accordionRef, forwardedRef), getItems = useCollection(__scopeAccordion || ACCORDION_CONTEXT), isDirectionLTR = useDirection(dir) === "ltr", handleKeyDown = composeEventHandlers(props.onKeyDown, (event) => {
  ...
  return (0, import_jsx_runtime7.jsx)(AccordionImplProvider, {
    scope: __scopeAccordion,
    disabled,
    direction: dir,
    orientation,
    children: (0, import_jsx_runtime7.jsx)(Collection.Slot, {
      scope: __scopeAccordion || ACCORDION_CONTEXT,
      children: (0, import_jsx_runtime7.jsx)(YStack, {
...
var AccordionItem = React11.forwardRef((props, forwardedRef) => {
  const {
    __scopeAccordion,
    value,
    ...accordionItemProps
  } = props, accordionContext = useAccordionContext(__scopeAccordion), valueContext = useAccordionValueContext(__scopeAccordion), triggerId = React11.useId(), open = value && valueContext.value.includes(value) || false, disabled = accordionContext.disabled || props.disabled;
  return (0, import_jsx_runtime7.jsx)(AccordionItemProvider, {
    scope: __scopeAccordion,
    open,
    disabled,
    triggerId,
    children: (0, import_jsx_runtime7.jsx)(Collapsible, {
...
var AccordionTrigger = AccordionTriggerFrame.styleable(function(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime7.jsx)(Collection.ItemSlot, {
    scope: __scopeAccordion || ACCORDION_CONTEXT,
    children: (0, import_jsx_runtime7.jsx)(AccordionTriggerFrame, {
      __scopeCollapsible: __scopeAccordion || ACCORDION_CONTEXT,
...
var AccordionContent = AccordionContentFrame.styleable(function(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime7.jsx)(AccordionContentFrame, {
    role: "region",
...
var HeightAnimator = View.styleable((props, ref) => {
  const itemContext = useAccordionItemContext(), {
    children,
    ...rest
  } = props, [height, setHeight] = React11.useState(0);
  return (0, import_jsx_runtime7.jsx)(View, {
    ref,
    height: itemContext.open ? height : 0,
    ...rest,
    children: (0, import_jsx_runtime7.jsx)(View, {
      position: "absolute",
      width: "100%",
      onLayout: ({
        nativeEvent
...
var ZIndexStackContext = (0, import_react9.createContext)(1);
var ZIndexHardcodedContext = (0, import_react9.createContext)(void 0);
...
var useStackedZIndex = (props) => {
  if (process.env.TAMAGUI_STACK_Z_INDEX_GLOBAL) {
    const {
      stackZIndex,
      zIndex: zIndexProp
    } = props, id = (0, import_react10.useId)(), zIndex = (0, import_react10.useMemo)(() => {
    ...
    const {
      stackZIndex,
      zIndex: zIndexProp
    } = props, id = (0, import_react10.useId)(), stackingContextLevel = (0, import_react10.useContext)(ZIndexStackContext), stackLayer = stackZIndex === "global" ? 0 : stackingContextLevel, hardcoded = (0, import_react10.useContext)(ZIndexHardcodedContext);
    ZIndicesByContext[stackLayer] ||= {};
    const stackContext = ZIndicesByContext[stackLayer], zIndex = (0, import_react10.useMemo)(() => {
...
var StackZIndexContext = ({
  ...
  const existing = (0, import_react11.useContext)(ZIndexStackContext);
  let content = (0, import_jsx_runtime8.jsx)(ZIndexStackContext.Provider, {
    value: existing + 1,
    children
  });
  return typeof zIndex < "u" && (content = (0, import_jsx_runtime8.jsx)(ZIndexHardcodedContext.Provider, {
    value: zIndex,
    children: content
  })), content;
};
...
var Portal = React12.memo((propsIn) => {
  ...
  return passThrough ? children : (0, import_react_dom.createPortal)((0, import_jsx_runtime9.jsx)("span", {
    style: {
      zIndex,
      position: "fixed",
      inset: 0,
...
var PortalStateContext = (0, import_react12.createContext)(null);
var PortalDispatchContext = (0, import_react12.createContext)(null);
var usePortalState = (hostName) => {
  const state = (0, import_react12.useContext)(PortalStateContext);
...
var usePortal = (hostName = "root") => {
  const dispatch = (0, import_react12.useContext)(PortalDispatchContext);
  if (dispatch === null) throw new Error("'PortalDispatchContext' cannot be null, please add 'PortalProvider' to the root component.");
  const registerHost2 = (0, import_react12.useCallback)(() => {
    dispatch({
      type: 0,
      hostName
    });
  }, []), deregisterHost2 = (0, import_react12.useCallback)(() => {
    dispatch({
      type: 1,
      hostName
    });
  }, []), addUpdatePortal2 = (0, import_react12.useCallback)((name, node) => {
    dispatch({
      type: 2,
      hostName,
      portalName: name,
  ...
  }, []), removePortal2 = (0, import_react12.useCallback)((name) => {
    dispatch({
      type: 3,
      hostName,
      portalName: name
...
var PortalProviderComponent = ({
  ...
  const [state, dispatch] = (0, import_react12.useReducer)(reducer, INITIAL_STATE), transitionDispatch = (0, import_react12.useMemo)(() => (value) => {
    startTransition(() => {
      dispatch(value);
    });
  }, [dispatch]);
  return (0, import_jsx_runtime10.jsx)(PortalDispatchContext.Provider, {
    value: transitionDispatch,
    children: (0, import_jsx_runtime10.jsxs)(PortalStateContext.Provider, {
      value: state,
      children: [children, shouldAddRootHost && (0, import_jsx_runtime10.jsx)(PortalHost, {
        name: rootHostName
      })]
    })
  });
};
var PortalProvider = (0, import_react12.memo)(PortalProviderComponent);
PortalProvider.displayName = "PortalProvider";
var defaultRenderer = (children) => (0, import_jsx_runtime10.jsx)(import_jsx_runtime10.Fragment, {
  children
});
var PortalHost = (0, import_react12.memo)(function(props) {
  return isWeb ? (0, import_jsx_runtime10.jsx)(PortalHostWeb, {
    ...props
  }) : (0, import_jsx_runtime10.jsx)(PortalHostNonNative, {
    ...props
  });
});
function PortalHostWeb(props) {
  ...
  }, [props.name]), (0, import_jsx_runtime10.jsx)("div", {
    style: {
      display: "contents"
    },
    ref: (node) => {
...
function PortalHostNonNative(props) {
  ...
  return useIsomorphicLayoutEffect(() => {
    ...
    return forwardProps ? import_react12.default.Children.map(next, (child) => import_react12.default.isValidElement(child) ? import_react12.default.cloneElement(child, {
      key: child.key,
      ...restForwardProps
    }) : child) : next;
...
var GorhomPortalItem = (props) => {
  ...
  const cur = allPortalHosts.get(props.hostName || ""), [node, setNode] = (0, import_react13.useState)(cur);
  if (useIsomorphicLayoutEffect(() => {
...
var LastAdaptContextScope = (0, import_react14.createContext)("");
var ProvideAdaptContext = ({
  children,
  ...context2
}) => {
  const scope = context2.scopeName || "", lastScope = (0, import_react14.useContext)(LastAdaptContextScope);
  return (0, import_jsx_runtime11.jsx)(LastAdaptContextScope.Provider, {
    value: lastScope || context2.lastScope || "",
    children: (0, import_jsx_runtime11.jsx)(AdaptContext.Provider, {
      scope,
...
var useAdaptContext = (scope) => {
  const lastScope = (0, import_react14.useContext)(LastAdaptContextScope), adaptScope = scope ?? lastScope;
...
var AdaptParent = ({
  ...
  const id = (0, import_react14.useId)(), portalName = `AdaptPortal${scope}${id}`, FinalContents = (0, import_react14.useMemo)(() => {
    if (Contents) return Contents;
    if (AdaptPortals.has(portalName)) return AdaptPortals.get(portalName);
    const element = () => (0, import_jsx_runtime11.jsx)(PortalHost, {
      name: portalName,
  ...
  const [when, setWhen] = import_react14.default.useState(null), [platform2, setPlatform] = import_react14.default.useState(null), [children2, setChildren] = import_react14.default.useState(null);
  return (0, import_jsx_runtime11.jsx)(LastAdaptContextScope.Provider, {
    value: scope,
    children: (0, import_jsx_runtime11.jsx)(ProvideAdaptContext, {
...
var AdaptContents = ({
  ...
  if (!context2?.Contents) throw new Error(false ? "tamagui.dev/docs/intro/errors#warning-002" : "You're rendering a Tamagui <Adapt /> component without nesting it inside a parent that is able to adapt.");
  return import_react14.default.createElement(context2.Contents, {
    ...rest,
    key: "stable"
  });
};
...
var Adapt = withStaticProperties(function(props) {
  ...
  if (typeof children == "function") {
    ...
    output = children(Component ? (0, import_jsx_runtime11.jsx)(Component, {}) : null);
  } else output = children;
  return useIsomorphicLayoutEffect(() => {
    typeof children == "function" && output !== void 0 && context2?.setChildren(output);
  }, [output]), (0, import_jsx_runtime11.jsx)(StackZIndexContext, {
...
var AdaptPortalContents = (props) => {
  ...
  return (0, import_jsx_runtime11.jsx)(GorhomPortalItem, {
...
function createContext6(rootComponentName, defaultContext) {
  ...
  function Provider(props) {
    const {
      children,
      ...context2
    } = props, value = React15.useMemo(() => context2, Object.values(context2));
  ...
  function useContext16(consumerName) {
    const context2 = React15.useContext(Context);
...
function createContextScope(scopeName, createContextScopeDeps = []) {
  ...
  function createContext22(rootComponentName, defaultContext) {
    const BaseContext = React15.createContext(defaultContext), index3 = defaultContexts.length;
    ...
    function Provider(props) {
      const {
        ...
        children,
        ...context2
      } = props, Context = scope?.[scopeName]?.[index3] || BaseContext, value = React15.useMemo(() => context2, Object.values(context2));
      return (0, import_jsx_runtime12.jsx)(Context.Provider, {
        value,
        children
      });
    ...
    function useContext16(consumerName, scope, options) {
      const Context = scope?.[scopeName]?.[index3] || BaseContext, context2 = React15.useContext(Context);
      if (context2) return context2;
      if (defaultContext !== void 0) return defaultContext;
  ...
  const createScope = () => {
    const scopeContexts = defaultContexts.map((defaultContext) => React15.createContext(defaultContext));
...
function useCallbackRef(callback) {
  ...
  }), React16.useMemo(() => (...args) => callbackRef.current?.(...args), []);
}
...
var DismissableContext = React18.createContext({
  layers: /* @__PURE__ */ new Set(),
  layersWithOutsidePointerEventsDisabled: /* @__PURE__ */ new Set(),
  branches: /* @__PURE__ */ new Set()
});
var Dismissable = React18.forwardRef((props, forwardedRef) => {
  const {
...
var DismissableBranch = React18.forwardRef((props, forwardedRef) => {
  const context2 = React18.useContext(DismissableContext), ref = React18.useRef(null), composedRefs = useComposedRefs(forwardedRef, ref);
  return React18.useEffect(() => {
    const node = ref.current;
    if (node) return context2.branches.add(node), () => {
      context2.branches.delete(node);
    };
  }, [context2.branches]), (0, import_jsx_runtime13.jsx)("div", {
    style: {
      display: "contents"
    },
    ...props,
...
function usePointerDownOutside(onPointerDownOutside) {
  const handlePointerDownOutside = useEvent(onPointerDownOutside), isPointerInsideReactTreeRef = React18.useRef(false), handleClickRef = React18.useRef(() => {
  });
  return React18.useEffect(() => {
...
function useFocusOutside(onFocusOutside) {
  const handleFocusOutside = useEvent(onFocusOutside), isFocusInsideReactTreeRef = React18.useRef(false);
  return React18.useEffect(() => {
...
function useAsyncEffect(cb, deps = []) {
  useAsyncEffectOfType(import_react16.useEffect, cb, deps);
}
function useAsyncEffectOfType(type, cb, deps = []) {
  type(() => {
    ...
    function handleError(error2) {
      if (error2 instanceof AbortError) return DEBUG_LEVEL > 2 && console.info(`🐛 useAsyncEffect aborted: ${error2.message}`), null;
...
var idleAsync = () => new Promise((res) => {
  idleCb(res);
});
var idle = async (signal, options) => {
  const {
    max: max2,
    min: min2,
    fully
...
function FocusScopeController(props) {
  const {
    ...
    forceUnmount,
    focusOnIdle
  } = props, stableOnMountAutoFocus = useEvent(onMountAutoFocus), stableOnUnmountAutoFocus = useEvent(onUnmountAutoFocus), contextValue = React19.useMemo(() => ({
    enabled,
    loop,
    trapped,
  ...
  return (0, import_jsx_runtime14.jsx)(FocusScopeControllerProvider, {
...
var FocusScope = React20.forwardRef(function({
  __scopeFocusScope,
  ...props
}, forwardedRef) {
  ...
  return typeof mergedProps.children == "function" ? (0, import_jsx_runtime15.jsx)(import_jsx_runtime15.Fragment, {
    children: mergedProps.children(childProps)
  }) : React20.cloneElement(React20.Children.only(mergedProps.children), childProps);
});
function useFocusScope(props, forwardedRef) {
  const {
    ...
    children,
    ...scopeProps
  } = props, [container, setContainer] = React20.useState(null), onMountAutoFocus = useEvent(onMountAutoFocusProp), onUnmountAutoFocus = useEvent(onUnmountAutoFocusProp), lastFocusedElementRef = React20.useRef(null), setContainerTransition = React20.useCallback((node) => {
    startTransition(() => {
      setContainer(node);
    });
  }, [setContainer]), composedRefs = useComposedRefs(forwardedRef, setContainerTransition), focusScope = React20.useRef({
    paused: false,
    pause() {
      this.paused = true;
    },
  ...
  const existingOnKeyDown = scopeProps.onKeyDown, composedOnKeyDown = React20.useCallback((event) => {
...
var useDisableBodyScroll = (enabled) => {
...
var RemoveScroll = (props) => (useDisableBodyScroll(!!props.enabled), props.children);
...
var useSheetController = () => {
  const controller = import_react19.default.useContext(SheetControllerContext), isHidden4 = controller?.hidden, isShowingNonSheet = isHidden4 && controller?.open;
  return {
    controller,
    isHidden: isHidden4,
    isShowingNonSheet,
...
function useSheetProviderProps(props, state, options = {}) {
  const handleRef = import_react20.default.useRef(null), contentRef = import_react20.default.useRef(null), [frameSize, setFrameSize] = import_react20.default.useState(0), [maxContentSize, setMaxContentSize] = import_react20.default.useState(0), snapPointsMode = props.snapPointsMode ?? "percent", snapPointsProp = props.snapPoints ?? (snapPointsMode === "percent" ? [80] : snapPointsMode === "constant" ? [256] : ["fit"]), hasFit = snapPointsProp[0] === "fit", snapPoints = import_react20.default.useMemo(() => props.dismissOnSnapToBottom ? [...snapPointsProp, 0] : snapPointsProp, [JSON.stringify(snapPointsProp), props.dismissOnSnapToBottom]), [position_, setPositionImmediate] = useControllableState({
    prop: props.position,
    ...
    open
  } = state, setPosition = import_react20.default.useCallback((next) => {
...
var SheetImplementationCustom = import_react21.default.forwardRef(function(props, forwardedRef) {
  const parentSheet = import_react21.default.useContext(ParentSheetContext), {
    animation,
    ...
    portalProps,
    containerComponent: ContainerComponent = import_react21.default.Fragment
  } = props, state = useSheetOpenState(props), [overlayComponent, setOverlayComponent] = import_react21.default.useState(null), providerProps = useSheetProviderProps(props, state, {
    ...
    controller,
    isHidden: isHidden4
  } = state, sheetRef = import_react21.default.useRef(void 0), ref = useComposedRefs(forwardedRef, sheetRef, providerProps.contentRef), {
    animationDriver
  } = useConfiguration();
  ...
  })(), [isShowingInnerSheet, setIsShowingInnerSheet] = import_react21.default.useState(false), shouldHideParentSheet = !isWeb && modal && isShowingInnerSheet && // if not using weird portal limitation we dont need to hide parent sheet
  USE_NATIVE_PORTAL, sheetInsideSheet = import_react21.default.useContext(SheetInsideSheetContext), onInnerSheet = import_react21.default.useCallback((hasChild) => {
    setIsShowingInnerSheet(hasChild);
  }, []), stableFrameSize = import_react21.default.useRef(frameSize);
  import_react21.default.useEffect(() => {
    open && frameSize && (stableFrameSize.current = frameSize);
  }, [open, frameSize]);
  const positions = import_react21.default.useMemo(() => snapPoints.map((point) => (
  ...
  const nextParentContext = import_react21.default.useMemo(() => ({
    zIndex
  }), [zIndex]), startPosition = useDidFinishSSR() && screenSize ? screenSize : hiddenSize, animatedNumber = useAnimatedNumber(startPosition), at = import_react21.default.useRef(startPosition), hasntMeasured = at.current === hiddenSize, [disableAnimation, setDisableAnimation] = (0, import_react21.useState)(hasntMeasured), hasScrollView = import_react21.default.useRef(false);
  useAnimatedNumberReaction({
    value: animatedNumber,
    hostRef: sheetRef
  }, import_react21.default.useCallback((value) => {
  ...
  useIsomorphicLayoutEffect(() => {
    ...
    disableAnimation || !frameSize || !screenSize || isHidden4 || hasntMeasured && !open || (animateTo(position), position === -1 && (scrollBridge.scrollLock = false, scrollBridge.scrollStartY = -1));
  }, [hasntMeasured, disableAnimation, isHidden4, frameSize, screenSize, open, position]);
  const disableDrag = props.disableDrag ?? controller?.disableDrag, themeName = useThemeName(), [isDragging, setIsDragging] = import_react21.default.useState(false), panResponder = import_react21.default.useMemo(() => {
  ...
  }, [disableDrag, isShowingInnerSheet, animateTo, frameSize, positions, setPosition]), handleAnimationViewLayout = import_react21.default.useCallback((e) => {
  ...
  }, [open]), handleMaxContentViewLayout = import_react21.default.useCallback((e) => {
    const next = Math.min(e.nativeEvent?.layout.height, Dimensions.get(relativeDimensionTo).height);
  ...
  }), sizeBeforeKeyboard = import_react21.default.useRef(null);
  import_react21.default.useEffect(() => {
  ...
  const [opacity, setOpacity] = import_react21.default.useState(open ? 1 : 0);
  open && opacity === 0 && setOpacity(1), import_react21.default.useEffect(() => {
    if (!open) {
      const tm = setTimeout(() => {
        setOpacity(0);
      }, 400);
  ...
  const forcedContentHeight = hasFit ? void 0 : snapPointsMode === "percent" ? `${maxSnapPoint}${isWeb ? "dvh" : "%"}` : maxSnapPoint, setHasScrollView = import_react21.default.useCallback((val) => {
    hasScrollView.current = val;
  }, []);
  let contents = (0, import_jsx_runtime16.jsx)(LayoutMeasurementController, {
    disable: !open,
    children: (0, import_jsx_runtime16.jsx)(ParentSheetContext.Provider, {
      value: nextParentContext,
      children: (0, import_jsx_runtime16.jsxs)(SheetProvider, {
        ...providerProps,
        setHasScrollView,
        children: [(0, import_jsx_runtime16.jsx)(AnimatePresence, {
          custom: {
            open
          },
          children: shouldHideParentSheet || !open ? null : overlayComponent
        }), snapPointsMode !== "percent" && (0, import_jsx_runtime16.jsx)(View_default, {
          style: {
            opacity: 0,
            position: "absolute",
            top: 0,
        ...
        }), (0, import_jsx_runtime16.jsx)(AnimatedView, {
          ref,
  ...
  if (modal) {
    const modalContents = (0, import_jsx_runtime16.jsx)(Portal, {
      stackZIndex: zIndex,
      ...portalProps,
      children: shouldMountChildren && (0, import_jsx_runtime16.jsx)(ContainerComponent, {
        children: (0, import_jsx_runtime16.jsx)(Theme, {
          contain: true,
          forceClassName: true,
          name: themeName,
          children: contents
    ...
    return isWeb ? modalContents : (0, import_jsx_runtime16.jsx)(SheetInsideSheetContext.Provider, {
      value: onInnerSheet,
...
var SheetScrollView = import_react22.default.forwardRef(({
  ...
  const context2 = useSheetContext(SHEET_SCROLL_VIEW_NAME, __scopeSheet), {
    ...
    defaultProp: true
  }), scrollRef = import_react22.default.useRef(null), setScrollEnabled = (next) => {
    scrollRef.current?.setNativeProps?.({
      scrollEnabled: next
    }), setScrollEnabled_(next);
  }, state = import_react22.default.useRef({
    lastPageY: 0,
    dragAt: 0,
    dys: [],
  ...
  (0, import_react22.useEffect)(() => (setHasScrollView(true), () => {
  ...
  const [hasScrollableContent, setHasScrollableContent] = (0, import_react22.useState)(true), parentHeight = (0, import_react22.useRef)(0), contentHeight = (0, import_react22.useRef)(0), setIsScrollable = () => {
  ...
  return (0, import_react22.useEffect)(() => {
  ...
  }, [hasScrollableContent]), (0, import_jsx_runtime17.jsxs)(ScrollView, {
    onLayout: (e) => {
    ...
    onStartShouldSetResponder: () => (scrollBridge.scrollStartY = -1, state.current.isDraggingScrollArea = true, false),
    onMoveShouldSetResponder: (e) => {
      if (!scrollable) return false;
      const {
        pageY
      } = e.nativeEvent;
      return state.current.lastPageY === 0 ? (state.current.lastPageY = pageY, false) : Math.abs(pageY - state.current.lastPageY) > 10;
    },
    ...
    ...props,
    children: [(0, import_jsx_runtime17.jsx)(View, {
      position: "absolute",
      inset: 0,
      pointerEvents: "none",
      zIndex: -1,
...
function createSheet({
  ...
  const SheetHandle = Handle2.styleable(({
    ...
    return context2.onlyShowFrame ? null : (
      // @ts-ignore
      (0, import_jsx_runtime18.jsx)(Handle2, {
        ref: composedRef,
        onPress: () => {
  ...
  }), SheetOverlay = Overlay2.extractable((0, import_react23.memo)((propsIn) => {
    const {
      __scopeSheet,
      ...props
    } = propsIn, context2 = useSheetContext(SHEET_OVERLAY_NAME, __scopeSheet), element = (0, import_react23.useMemo)(() => (
      // @ts-ignore
      (0, import_jsx_runtime18.jsx)(Overlay2, {
        ...props,
  ...
  })), SheetFrame = Frame2.extractable((0, import_react23.forwardRef)(({
    __scopeSheet,
    ...
    const context2 = useSheetContext(SHEET_NAME, __scopeSheet), {
      ...
      contentRef,
      open
    } = context2, composedContentRef = useComposedRefs(forwardedRef, contentRef), offscreenSize = useSheetOffscreenSize(context2), stableFrameSize = (0, import_react23.useRef)(frameSize);
    (0, import_react23.useEffect)(() => {
      open && frameSize && (stableFrameSize.current = frameSize);
    }, [open, frameSize]);
    const sheetContents = (0, import_react23.useMemo)(() => {
      const shouldUseFixedHeight = hasFit && !open && stableFrameSize.current;
      return (
        // @ts-expect-error
        (0, import_jsx_runtime18.jsxs)(Frame2, {
          ...
          "data-state": open ? "open" : "closed",
          ...props,
          children: [(0, import_jsx_runtime18.jsx)(StackZIndexContext, {
            zIndex: resolveViewZIndex(props.zIndex),
            children
          }), adjustPaddingForOffscreenContent && (0, import_jsx_runtime18.jsx)(Stack2, {
  ...
  })), Sheet2 = (0, import_react23.forwardRef)(function(props, ref) {
    const hydrated = useDidFinishSSR(), {
      isShowingNonSheet
    } = useSheetController();
    let SheetImplementation = SheetImplementationCustom;
    return props.native && Platform_default.OS, isShowingNonSheet || !hydrated ? null : (0, import_jsx_runtime18.jsx)(SheetImplementation, {
      ref,
      ...props
    });
  }), components = {
...
var SheetController = ({
  ...
  const onOpenChange = useEvent(onOpenChangeProp), id = (0, import_react24.useId)(), memoValue = import_react24.default.useMemo(() => ({
    id,
    open,
    hidden,
    disableDrag,
  ...
  return (0, import_jsx_runtime19.jsx)(SheetControllerContext.Provider, {
    value: memoValue,
    children
  });
};
...
function setupNativeSheet(platform2, RNIOSModal) {
  ...
  platform2 === "ios" && (nativeSheets[platform2] = (props) => {
    const state = useSheetOpenState(props), providerProps = useSheetProviderProps(props, state), {
      open,
      setOpen
    } = state, ref = (0, import_react25.useRef)(void 0);
    ...
    return (0, import_jsx_runtime20.jsx)(import_jsx_runtime20.Fragment, {
      children: (0, import_jsx_runtime20.jsxs)(SheetProvider, {
        setHasScrollView: emptyFn,
        ...providerProps,
        onlyShowFrame: true,
        children: [(0, import_jsx_runtime20.jsx)(ModalSheetView, {
          ref,
          onModalDidDismiss: () => setOpenInternal(false),
          children: (0, import_jsx_runtime20.jsx)(ModalSheetViewMainContent, {
            children: (0, import_jsx_runtime20.jsx)(View_default, {
              style: {
                flex: 1
              },
              children: props.children
        ...
        }), (0, import_jsx_runtime20.jsx)(YStack, {
          position: "absolute",
          opacity: 0,
          pointerEvents: "none",
          width: 0,
...
var DialogTrigger = DialogTriggerFrame.styleable(function(props, forwardedRef) {
  const {
    scope,
    ...triggerProps
  } = props, isInsideButton = React27.useContext(ButtonNestingContext), context2 = useDialogContext(scope), composedTriggerRef = useComposedRefs(forwardedRef, context2.triggerRef);
  return (0, import_jsx_runtime21.jsx)(ButtonNestingContext.Provider, {
    value: true,
    children: (0, import_jsx_runtime21.jsx)(DialogTriggerFrame, {
...
var DialogPortalItem = ({
  context: context2,
  children
}) => {
  const themeName = useThemeName(), isAdapted = useAdaptIsActive(context2.adaptScope), adaptContext = useAdaptContext(context2.adaptScope);
  let content = (0, import_jsx_runtime21.jsx)(Theme, {
    name: themeName,
    children
  });
  return needsRepropagation && (content = (0, import_jsx_runtime21.jsx)(ProvideAdaptContext, {
    ...adaptContext,
    children: (0, import_jsx_runtime21.jsx)(DialogProvider, {
      ...context2,
      children: content
    })
  })), isAdapted ? (0, import_jsx_runtime21.jsx)(AdaptPortalContents, {
    scope: context2.adaptScope,
    children: content
  }) : context2.modal ? (0, import_jsx_runtime21.jsx)(GorhomPortalItem, {
    hostName: context2.modal ? "root" : context2.adaptScope,
    children: content
  }) : content;
};
var DialogPortal = React27.forwardRef((props, forwardRef24) => {
  const {
    scope,
    forceMount,
    children,
    ...frameProps
  } = props, dialogRef = React27.useRef(null), ref = composeRefs(dialogRef, forwardRef24), context2 = useDialogContext(scope), isMountedOrOpen = forceMount || context2.open, [isFullyHidden, setIsFullyHidden] = React27.useState(!isMountedOrOpen), isAdapted = useAdaptIsActive(context2.adaptScope), isVisible = isMountedOrOpen ? true : !isFullyHidden;
  ...
  const handleExitComplete = React27.useCallback(() => {
    setIsFullyHidden(true);
  }, []), zIndex = getExpandedShorthand("zIndex", props), contents = (0, import_jsx_runtime21.jsx)(StackZIndexContext, {
    zIndex: resolveViewZIndex(zIndex),
    children: (0, import_jsx_runtime21.jsx)(AnimatePresence, {
    ...
    isFullyHidden && !isAdapted ? null : (0, import_jsx_runtime21.jsx)(LayoutMeasurementController, {
      disable: !isMountedOrOpen,
      children: (0, import_jsx_runtime21.jsx)(DialogPortalFrame, {
        ref,
  ...
  return isWeb ? (0, import_jsx_runtime21.jsx)(Portal, {
    zIndex,
    stackZIndex: 1e3,
    passThrough: isAdapted,
    children: (0, import_jsx_runtime21.jsx)(PassthroughTheme, {
      passThrough: isAdapted,
      children: framedContents
    })
  }) : isAdapted ? framedContents : (0, import_jsx_runtime21.jsx)(DialogPortalItem, {
    context: context2,
    children: framedContents
  });
});
var PassthroughTheme = ({
  ...
  return (0, import_jsx_runtime21.jsx)(Theme, {
    passThrough,
    name: themeName,
    forceClassName: true,
    children
...
var DialogOverlay = DialogOverlayFrame.styleable(function({
  ...
  return !forceMount && (!context2.modal || isAdapted) ? null : (0, import_jsx_runtime21.jsx)(DialogOverlayFrame, {
    "data-state": getState3(context2.open),
...
var DialogContent = DialogContentFrame.styleable(function({
  ...
  const context2 = useDialogContext(scope), {
    forceMount = context2.forceMount,
    ...contentProps
  } = props, contents = (0, import_jsx_runtime21.jsx)(import_jsx_runtime21.Fragment, {
    children: context2.modal ? (0, import_jsx_runtime21.jsx)(DialogContentModal, {
      context: context2,
      ...contentProps,
      ref: forwardedRef
    }) : (0, import_jsx_runtime21.jsx)(DialogContentNonModal, {
      context: context2,
      ...contentProps,
      ref: forwardedRef
    })
  });
  return !isWeb || context2.disableRemoveScroll ? contents : (0, import_jsx_runtime21.jsx)(RemoveScroll, {
...
var DialogContentModal = React27.forwardRef(({
  ...
  const contentRef = React27.useRef(null), composedRefs = useComposedRefs(forwardedRef, context2.contentRef, contentRef);
  return (0, import_jsx_runtime21.jsx)(DialogContentImpl, {
    ...props,
    context: context2,
    ref: composedRefs,
...
var DialogContentNonModal = React27.forwardRef((props, forwardedRef) => {
...
var DialogContentImpl = React27.forwardRef((props, forwardedRef) => {
  const {
    trapFocus,
    onOpenAutoFocus,
    onCloseAutoFocus,
    ...
    context: context2,
    ...contentProps
  } = props, contentRef = React27.useRef(
    // TODO react 19 type workaround
    void 0
  ), composedRefs = useComposedRefs(forwardedRef, contentRef);
  if (useAdaptIsActive(context2.adaptScope)) return !isWeb && !context2.open ? null : (0, import_jsx_runtime21.jsx)(DialogPortalItem, {
    context: context2,
    children: contentProps.children
  });
  const contents = (0, import_jsx_runtime21.jsx)(DialogContentFrame, {
    ref: composedRefs,
  ...
  return isWeb ? (0, import_jsx_runtime21.jsxs)(import_jsx_runtime21.Fragment, {
    children: [(0, import_jsx_runtime21.jsx)(Dismissable, {
      ...
      children: (0, import_jsx_runtime21.jsx)(FocusScope, {
        loop: true,
        enabled: context2.open,
        trapped: trapFocus,
      ...
      children: [(0, import_jsx_runtime21.jsx)(TitleWarning, {
        titleId: context2.titleId
      }), (0, import_jsx_runtime21.jsx)(DescriptionWarning, {
        contentRef,
...
var DialogTitle = DialogTitleFrame.styleable(function(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime21.jsx)(DialogTitleFrame, {
    id: context2.titleId,
    ...titleProps,
    ref: forwardedRef
  });
...
var DialogDescription = DialogDescriptionFrame.styleable(function(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime21.jsx)(DialogDescriptionFrame, {
...
var DialogClose = DialogCloseFrame.styleable((props, forwardedRef) => {
  const {
    ...
    displayWhenAdapted,
    ...closeProps
  } = props, context2 = useDialogContext(scope), isAdapted = useAdaptIsActive(context2.adaptScope), isInsideButton = React27.useContext(ButtonNestingContext);
  return isAdapted && !displayWhenAdapted ? null : (0, import_jsx_runtime21.jsx)(DialogCloseFrame, {
...
var Dialog = withStaticProperties(React27.forwardRef(function(props, ref) {
  const {
    scope = "",
    children,
    open: openProp,
  ...
  } = props, baseId = React27.useId(), dialogId = `Dialog-${scope}-${baseId}`, contentId = `${dialogId}-content`, titleId = `${dialogId}-title`, descriptionId = `${dialogId}-description`, triggerRef = React27.useRef(null), contentRef = React27.useRef(null), [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen,
    onChange: onOpenChange
  }), onOpenToggle = React27.useCallback(() => {
  ...
  return React27.useImperativeHandle(ref, () => ({
    open: setOpen
  }), [setOpen]), (0, import_jsx_runtime21.jsx)(AdaptParent, {
    scope: adaptScope,
    portal: {
      forwardProps: props
    },
    children: (0, import_jsx_runtime21.jsx)(DialogProvider, {
      scope,
      ...context2,
      children: (0, import_jsx_runtime21.jsx)(DialogSheetController, {
        onOpenChange: setOpen,
        scope,
        children
      })
...
var DialogSheetController = (props) => {
  ...
  return (0, import_jsx_runtime21.jsx)(SheetController, {
    onOpenChange: (val) => {
...
var getAlertDialogScope = (scope) => scope;
...
var AlertDialogTrigger = NativeAlertDialogTriggerFrame.styleable(function(props, forwardedRef) {
  if (props.__native) {
    ...
    return (0, import_jsx_runtime22.jsx)(NativeAlertDialogTriggerFrame, {
      ...rest,
  ...
  return (0, import_jsx_runtime22.jsx)(DialogTrigger, {
...
var AlertDialogPortal = function(props) {
  ...
  return (0, import_jsx_runtime22.jsx)(DialogPortal, {
    scope: getAlertDialogScope(scope),
    ...portalProps
  });
};
...
var AlertDialogOverlay = AlertDialogOverlayFrame.styleable(function(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime22.jsx)(DialogOverlay, {
    scope: getAlertDialogScope(scope),
    ...overlayProps,
    ref: forwardedRef
  });
...
var AlertDialogContent = React28.forwardRef(function(props, forwardedRef) {
  const {
    scope,
    children,
    ...contentProps
  } = props, dialogScope = getAlertDialogScope(scope), contentRef = React28.useRef(null), composedRefs = useComposedRefs(forwardedRef, contentRef), cancelRef = React28.useRef(null);
  return (0, import_jsx_runtime22.jsx)(DialogWarningProvider, {
    contentName: CONTENT_NAME3,
    titleName: TITLE_NAME,
    docsSlug: "alert-dialog",
    children: (0, import_jsx_runtime22.jsx)(AlertDialogContextProvider, {
      scope,
      cancelRef,
      children: (0, import_jsx_runtime22.jsxs)(DialogContent, {
        role: "alertdialog",
        "aria-modal": true,
        scope: dialogScope,
        ...contentProps,
        ...
        children: [(0, import_jsx_runtime22.jsx)(Slottable, {
          children
        }), (0, import_jsx_runtime22.jsx)(DescriptionWarning2, {
          contentRef
        })]
      })
    })
...
var AlertDialogTitleFrame = styled(View, {
  name: TITLE_NAME
});
var AlertDialogTitle = AlertDialogTitleFrame.styleable(function(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime22.jsx)(DialogTitle, {
    scope: getAlertDialogScope(scope),
    ...titleProps,
    ref: forwardedRef
  });
...
var AlertDialogDescriptionFrame = styled(View, {
...
var AlertDialogDescription = AlertDialogDescriptionFrame.styleable(function(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime22.jsx)(DialogDescription, {
    scope: getAlertDialogScope(scope),
    ...descriptionProps,
    ref: forwardedRef
  });
...
var AlertDialogActionFrame = styled(View, {
  name: ACTION_NAME
});
var AlertDialogAction = AlertDialogActionFrame.styleable(function(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime22.jsx)(DialogClose, {
    scope: getAlertDialogScope(scope),
    ...actionProps,
    ref: forwardedRef
  });
...
var AlertDialogCancelFrame = styled(View, {
  name: CANCEL_NAME
});
...
var AlertDialogInner = (props) => {
  ...
  return (0, import_jsx_runtime22.jsx)(Dialog, {
    scope: dialogScope,
    ...alertDialogProps,
    modal: true
  });
...
var Image = StyledImage.styleable((inProps, ref) => {
  ...
  return finalSource && typeof finalSource == "object" && (process.env.TAMAGUI_IMAGE_CHECK_ERROR && import_react26.default.useEffect(() => {
    async function run() {
    ...
    run();
  }, [src]), finalSource.default && (finalSource = finalSource.default)), (0, import_jsx_runtime23.jsx)(Image_default, {
...
var AvatarImage = React30.forwardRef((props, forwardedRef) => {
  const {
    ...
    ...imageProps
  } = props, context2 = useAvatarContext(IMAGE_NAME, __scopeAvatar), [status, setStatus] = React30.useState("idle"), shapeSize = getVariableValue(getShapeSize(
    context2.size,
    // @ts-expect-error
    {
      tokens: getTokens()
  ...
  }, [status]), resolvedSrc ? (0, import_jsx_runtime24.jsx)(YStack, {
    fullscreen: true,
    zIndex: 1,
    children: (0, import_jsx_runtime24.jsx)(Image, {
      fullscreen: true,
...
var AvatarFallback = AvatarFallbackFrame.extractable(React30.forwardRef((props, forwardedRef) => {
  const {
    __scopeAvatar,
    delayMs,
    ...fallbackProps
  } = props, context2 = useAvatarContext(FALLBACK_NAME, __scopeAvatar), [canRender, setCanRender] = React30.useState(delayMs === void 0);
  return React30.useEffect(() => {
    if (delayMs !== void 0) {
      const timerId = setTimeout(() => setCanRender(true), delayMs);
      return () => clearTimeout(timerId);
    }
  }, [delayMs]), canRender && context2.imageLoadingStatus !== "loaded" ? (0, import_jsx_runtime24.jsx)(AvatarFallbackFrame, {
    ...fallbackProps,
    ref: forwardedRef
  }) : null;
}));
...
var Avatar = withStaticProperties(React30.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime24.jsx)(AvatarProvider, {
    size: size4,
    scope: __scopeAvatar,
    imageLoadingStatus,
    onImageLoadingStatusChange: setImageLoadingStatus,
    children: (0, import_jsx_runtime24.jsx)(AvatarFrame, {
      size: size4,
      ...avatarProps,
      ref: forwardedRef
    })
...
var ButtonComponent = ButtonFrame.styleable(function(props, ref) {
  ...
  return (0, import_jsx_runtime25.jsx)(ButtonFrame, {
...
function useButton({
  ...
  const isNested = (0, import_react28.useContext)(ButtonNestingContext), propsActive = useProps(propsIn, {
    noNormalize: true,
    noExpand: true
  }), {
    icon,
    ...
    ...restProps,
    children: (0, import_jsx_runtime25.jsx)(ButtonNestingContext.Provider, {
      value: true,
      children: inner2
    }),
...
function useFocusable({
  ...
  const {
    ...
    value,
    defaultValue
  } = props, inputValue = import_react29.default.useRef(value || defaultValue || ""), unregisterFocusable = import_react29.default.useRef(void 0), focusAndSelect = import_react29.default.useCallback((input) => {
  ...
  }, [id, isInput3, focusAndSelect]), inputRef = import_react29.default.useCallback((input) => {
...
var LabelFrame = styled(SizableText2, {
  name: "Label",
  tag: "label",
  variants: {
    unstyled: {
...
var LabelComponent = React33.forwardRef((props, forwardedRef) => {
  const {
    htmlFor,
    id: idProp,
    ...labelProps
  ...
  }, [id, htmlFor]), (0, import_jsx_runtime26.jsx)(LabelProvider, {
    id,
    controlRef,
    children: (0, import_jsx_runtime26.jsx)(LabelFrame, {
      id,
      htmlFor,
      ...labelProps,
      ref: composedRefs,
...
var BubbleInput = (props) => {
  ...
  }, [prevChecked, checked, bubbles]), (0, import_jsx_runtime27.jsx)("input", {
    type: "checkbox",
...
function useCheckbox(props, [checked, setChecked], ref) {
  ...
  return {
    bubbleInput: isWeb && isFormControl ? (0, import_jsx_runtime28.jsx)(BubbleInput, {
      isHidden: true,
      control: button,
...
function createCheckbox(createProps) {
  ...
  const FrameComponent = Frame2.styleable(function(_props, forwardedRef) {
    const {
      ...
      unstyled = false,
      ...props
    } = _props, propsActive = useProps(props), styledContext = import_react31.default.useContext(CheckboxStyledContext);
    ...
    if (shouldRenderNativePlatform(native) === "web") return (0, import_jsx_runtime29.jsx)("input", {
      type: "checkbox",
      defaultChecked: isIndeterminate(checked) ? false : checked,
      tabIndex: -1,
      ref: checkboxRef,
    ...
    return (0, import_jsx_runtime29.jsx)(CheckboxContext.Provider, {
      value: memoizedContext,
      children: (0, import_jsx_runtime29.jsxs)(CheckboxStyledContext.Provider, {
        size: propsActive.size ?? styledContext?.size ?? "$true",
        scaleIcon: scaleIcon ?? styledContext?.scaleIcon ?? 1,
        children: [(0, import_jsx_runtime29.jsx)(Frame2, {
          ...!unstyled && {
            width: size4,
            height: size4
          },
    ...
    return forceMount || isIndeterminate(context2.checked) || context2.checked === true ? (0, import_jsx_runtime29.jsx)(Indicator, {
      pointerEvents: "none",
      ...indicatorProps,
      ref: forwardedRef,
      children
...
var FormTrigger = FormTriggerFrame.styleable((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime30.jsx)(FormTriggerFrame, {
    tag: "button",
    ...triggerProps,
    ref: forwardedRef,
...
var FormComponent = FormFrame.extractable(function({
  ...
  return (0, import_jsx_runtime30.jsx)(FormProvider, {
    scope: props.__scopeForm,
    onSubmit,
    children: (0, import_jsx_runtime30.jsx)(FormFrame, {
      ...props,
...
function useIndexedChildren(children) {
  ...
  return (0, import_jsx_runtime31.jsx)(MaxIndexContext.Provider, {
    value: maxIndexPath,
    children: React38.Children.map(children, (child, index3) => React38.isValidElement(child) ? (0, import_jsx_runtime31.jsx)(IndexContext.Provider, {
...
function createGroup(verticalDefault) {
  return withStaticProperties(GroupFrame.styleable((props, ref) => {
    ...
    return (0, import_jsx_runtime32.jsx)(GroupProvider, {
      ...
      onItemUnmount,
      scope: __scopeGroup,
      children: (0, import_jsx_runtime32.jsx)(GroupFrame, {
        ref,
        size: size4,
...
var GroupItem = import_react32.default.forwardRef((props, _ref) => {
  const {
    ...
    disabled: import_react32.default.isValidElement(children) ? children.props.disabled : false
...
}, children) => scrollable ? (0, import_jsx_runtime32.jsx)(ScrollView_default, {
  ...orientation === "vertical" && {
...
var cloneElementWithPropOrder = (child, props) => import_react32.default.cloneElement({
  ...child,
  props: null
}, {
  ...child.props,
...
var ListItemText = styled(SizableText2, {
  name: "ListItemText",
  variants: {
    unstyled: {
      false: {
...
var useListItem = (propsIn, {
  ...
  return {
    props: {
      ...rest,
      children: (0, import_jsx_runtime33.jsxs)(import_jsx_runtime33.Fragment, {
        children: [themedIcon ? (0, import_jsx_runtime33.jsxs)(import_jsx_runtime33.Fragment, {
          children: [themedIcon, (0, import_jsx_runtime33.jsx)(Spacer, {
            size: spaceSize
          })]
        }) : null, title || subTitle ? (0, import_jsx_runtime33.jsxs)(YStack, {
          flex: 1,
          children: [noTextWrap === "all" ? title : (0, import_jsx_runtime33.jsx)(Title, {
            size: size4,
            children: title
          }), subTitle ? (0, import_jsx_runtime33.jsx)(import_jsx_runtime33.Fragment, {
            children: typeof subTitle == "string" && noTextWrap !== "all" ? (
              // TODO can use theme but we need to standardize to alt themes
              // or standardize on subtle colors in themes
              (0, import_jsx_runtime33.jsx)(Subtitle, {
                unstyled,
                size: size4,
                children: subTitle
              })
        ...
        }) : contents, themedIconAfter ? (0, import_jsx_runtime33.jsxs)(import_jsx_runtime33.Fragment, {
...
var ListItemComponent = ListItemFrame.styleable(function(props, ref) {
  ...
  return (0, import_jsx_runtime33.jsx)(ListItemFrame, {
    ref,
    ...listItemProps
  });
});
...
function Animate({
  ...
  const [lazyMounted, setLazyMounted] = (0, import_react33.useState)(lazyMount ? false : present);
  (0, import_react33.useEffect)(() => {
    passThrough || lazyMount && present && (0, import_react33.startTransition)(() => {
      setLazyMounted(present);
    });
  }, [lazyMount, present]);
  const mounted = present ? lazyMount ? lazyMounted : present : false;
  return type === "presence" ? props.keepChildrenMounted ? (0, import_jsx_runtime34.jsx)(PresenceChild, {
    isPresent: true,
    ...!passThrough && {
    ...
    children
  }) : (0, import_jsx_runtime34.jsx)(AnimatePresence, {
    passThrough,
    ...props,
    children: mounted || passThrough ? children : null
  }) : (0, import_jsx_runtime34.jsx)(import_jsx_runtime34.Fragment, {
    children
  });
}
...
var useFloating2 = (props) => (import_react35.default.useContext(FloatingOverrideContext) || useFloating)?.({
  ...props,
  middleware: [
    // @ts-ignore
    ...props.middleware,
...
var PopperProvider = ({
  ...
  return (0, import_jsx_runtime35.jsx)(PopperProviderFast, {
    scope,
    ...context2,
    children: (0, import_jsx_runtime35.jsx)(PopperProviderSlow, {
      scope,
      ...slowContext,
      children
    })
...
function Popper(props) {
  const {
    ...
    open,
    scope
  } = props, [arrowEl, setArrow] = React42.useState(null), [arrowSize, setArrowSize] = React42.useState(0), offsetOptions = offset4 ?? arrowSize, floatingStyle = React42.useRef({}), isOpen = passThrough ? false : open || true;
  ...
  const {
    middlewareData
  } = floating, popperContext = React42.useMemo(() => ({
    size: size4,
    arrowRef: setArrow,
  ...
  return (0, import_jsx_runtime35.jsx)(LayoutMeasurementController, {
    disable: !isOpen,
    children: (0, import_jsx_runtime35.jsx)(PopperProvider, {
      scope,
      ...popperContext,
      children
    })
...
var PopperAnchor = YStack.extractable(React42.forwardRef(function(props, forwardedRef) {
  const {
    virtualRef,
    scope,
    ...anchorProps
    ...
    refs,
    update
  } = context2, ref = React42.useRef(null);
  React42.useEffect(() => {
    virtualRef && refs.setReference(virtualRef.current);
  }, [virtualRef]);
  const stackProps = anchorProps, safeSetReference = React42.useCallback((node) => {
    startTransition(() => {
  ...
  return (0, import_jsx_runtime35.jsx)(View, {
    ...stackProps,
    ...refProps,
    ref: composedRefs,
    ...shouldHandleInHover && {
...
var PopperContent = React42.forwardRef(function(props, forwardedRef) {
  const {
    scope,
    ...
    size: size4,
    isPositioned
  } = context2, safeSetFloating = React42.useCallback((node) => {
    startTransition(() => {
      refs.setFloating(node);
    });
  }, [refs.setFloating]), contentRefs = useComposedRefs(safeSetFloating, forwardedRef), [needsMeasure, setNeedsMeasure] = React42.useState(enableAnimationForPositionChange);
  useIsomorphicLayoutEffect(() => {
  ...
  ), [disableAnimation, setDisableAnimation] = React42.useState(disableAnimationProp);
  React42.useEffect(() => {
  ...
  return (0, import_jsx_runtime35.jsx)(View, {
    ...
    children: (0, import_jsx_runtime35.jsx)(PopperContentFrame, {
      passThrough,
      ...!passThrough && {
...
var PopperArrow = React42.forwardRef(function(propsIn, forwardedRef) {
  const {
    scope,
    ...rest
    ...
    borderWidth = 0,
    ...arrowProps
  } = props, context2 = usePopperContext(scope), sizeVal = typeof sizeProp == "number" ? sizeProp : getVariableValue(getSpace(sizeProp ?? context2.size, {
    shift: -2,
    bounds: [2]
  ...
  return (0, import_jsx_runtime35.jsx)(PopperArrowOuterFrame, {
    ref: refs,
    ...arrowStyle,
    children: (0, import_jsx_runtime35.jsx)(PopperArrowFrame, {
      width: size4,
      height: size4,
      ...arrowProps,
      ...innerArrowStyle,
...
function useMergeRefs(refs) {
  const cleanupRef = React44.useRef(void 0);
  const refEffect = React44.useCallback((instance) => {
...
var FloatingListContext = React44.createContext({
  register: () => {
  },
  unregister: () => {
  },
...
function FloatingList(props) {
  ...
  const [nodes, setNodes] = React44.useState(() => /* @__PURE__ */ new Set());
  const register = React44.useCallback((node) => {
    setNodes((prevSet) => new Set(prevSet).add(node));
  }, []);
  const unregister = React44.useCallback((node) => {
    setNodes((prevSet) => {
  ...
  return (0, import_jsx_runtime36.jsx)(FloatingListContext.Provider, {
...
function useListItem2(props) {
  ...
  const {
    ...
    elementsRef,
    labelsRef
  } = React44.useContext(FloatingListContext);
  const [index3, setIndex] = React44.useState(null);
  const componentRef = React44.useRef(null);
  const ref = React44.useCallback((node) => {
...
function renderJsx(render, computedProps) {
  ...
  if (render) {
    return React44.cloneElement(render, computedProps);
  }
  return (0, import_jsx_runtime36.jsx)("div", {
    ...computedProps
  });
}
var CompositeContext = React44.createContext({
  activeIndex: 0,
  onNavigate: () => {
  }
});
...
var Composite = React44.forwardRef(function Composite2(props, forwardedRef) {
  const {
    render,
    orientation = "both",
    loop = true,
  ...
  const [internalActiveIndex, internalSetActiveIndex] = React44.useState(0);
  ...
  return (0, import_jsx_runtime36.jsx)(CompositeContext.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime36.jsx)(FloatingList, {
      elementsRef,
      children: renderJsx(render, computedProps)
    })
  });
});
var CompositeItem = React44.forwardRef(function CompositeItem2(props, forwardedRef) {
  const {
    render,
    ...domProps
  } = props;
  ...
  const {
    activeIndex,
    onNavigate
  } = React44.useContext(CompositeContext);
  const {
    ref,
    index: index3
  } = useListItem2();
...
function useFloatingId() {
  const [id, setId] = React44.useState(() => serverHandoffComplete ? genId() : void 0);
  index2(() => {
    if (id == null) {
      setId(genId());
    }
...
var FloatingArrow = React44.forwardRef(function FloatingArrow2(props, ref) {
  const {
    context: {
      placement,
      elements: {
  ...
  const clipPathId = useId9();
  const [isRTL2, setIsRTL] = React44.useState(false);
  index2(() => {
    if (!floating) return;
  ...
  return (0, import_jsx_runtime36.jsxs)("svg", {
    ...rest,
    "aria-hidden": true,
    ref,
    ...
    children: [computedStrokeWidth > 0 && (0, import_jsx_runtime36.jsx)("path", {
      clipPath: "url(#" + clipPathId + ")",
      fill: "none",
      stroke,
      strokeWidth: computedStrokeWidth + (d ? 0 : 1),
      d: dValue
    }), (0, import_jsx_runtime36.jsx)("path", {
      stroke: computedStrokeWidth && !d ? rest.fill : "none",
      d: dValue
    }), (0, import_jsx_runtime36.jsx)("clipPath", {
      id: clipPathId,
...
var FloatingNodeContext = React44.createContext(null);
var FloatingTreeContext = React44.createContext(null);
var useFloatingParentNodeId = () => {
  var _React$useContext;
  return ((_React$useContext = React44.useContext(FloatingNodeContext)) == null ? void 0 : _React$useContext.id) || null;
};
var useFloatingTree = () => React44.useContext(FloatingTreeContext);
...
function useHover(context2, props) {
  ...
  const timeoutRef = React44.useRef(-1);
  const handlerRef = React44.useRef();
  const restTimeoutRef = React44.useRef(-1);
...
var FloatingDelayGroupContext = React44.createContext({
  delay: 0,
  initialDelay: 0,
  timeoutMs: 0,
  currentId: null,
...
var useDelayGroupContext = () => React44.useContext(FloatingDelayGroupContext);
function FloatingDelayGroup(props) {
  ...
  const [state, setState] = React44.useReducer((prev, next) => ({
    ...prev,
    ...next
  }), {
    delay,
  ...
  const initialCurrentIdRef = React44.useRef(null);
  const setCurrentId = React44.useCallback((currentId) => {
    setState({
      currentId
    });
  }, []);
  ...
  return (0, import_jsx_runtime36.jsx)(FloatingDelayGroupContext.Provider, {
    value: React44.useMemo(() => ({
      ...state,
      setState,
      setCurrentId
...
var NextFloatingDelayGroupContext = React44.createContext({
  hasProvider: false,
  timeoutMs: 0,
  delayRef: {
    current: 0
...
var FocusGuard = React44.forwardRef(function FocusGuard2(props, ref) {
  const [role, setRole] = React44.useState();
  index2(() => {
    if (isSafari()) {
      setRole("button");
    }
...
var PortalContext = React44.createContext(null);
...
function useFloatingPortalNode(props) {
  ...
  const [portalNode, setPortalNode] = React44.useState(null);
  const portalNodeRef = React44.useRef(null);
  index2(() => {
    return () => {
...
function FloatingPortal(props) {
  ...
  const [focusManagerState, setFocusManagerState] = React44.useState(null);
  const beforeOutsideRef = React44.useRef(null);
  const afterOutsideRef = React44.useRef(null);
  const beforeInsideRef = React44.useRef(null);
  const afterInsideRef = React44.useRef(null);
  ...
  return (0, import_jsx_runtime36.jsxs)(PortalContext.Provider, {
    value: React44.useMemo(() => ({
      preserveTabOrder,
      beforeOutsideRef,
      afterOutsideRef,
    ...
    children: [shouldRenderGuards && portalNode && (0, import_jsx_runtime36.jsx)(FocusGuard, {
      "data-type": "outside",
    ...
    }), shouldRenderGuards && portalNode && (0, import_jsx_runtime36.jsx)("span", {
      "aria-owns": portalNode.id,
      style: HIDDEN_OWNER_STYLES
    }), portalNode && ReactDOM3.createPortal(children, portalNode), shouldRenderGuards && portalNode && (0, import_jsx_runtime36.jsx)(FocusGuard, {
      "data-type": "outside",
      ref: afterOutsideRef,
      onFocus: (event) => {
        if (isOutsideEvent(event, portalNode)) {
...
var usePortalContext = () => React44.useContext(PortalContext);
...
var VisuallyHiddenDismiss = React44.forwardRef(function VisuallyHiddenDismiss2(props, ref) {
...
function FloatingFocusManager(props) {
  ...
  const tree = useFloatingTree();
  const portalContext = usePortalContext();
  const startDismissButtonRef = React44.useRef(null);
  const endDismissButtonRef = React44.useRef(null);
  const preventReturnFocusRef = React44.useRef(false);
  const isPointerDownRef = React44.useRef(false);
  const tabbableIndexRef = React44.useRef(-1);
  const blurTimeoutRef = React44.useRef(-1);
  ...
  const beforeGuardRef = React44.useRef(null);
  const afterGuardRef = React44.useRef(null);
  ...
  function renderDismissButton(location) {
    ...
    return (0, import_jsx_runtime36.jsx)(VisuallyHiddenDismiss, {
  ...
  return (0, import_jsx_runtime36.jsxs)(import_jsx_runtime36.Fragment, {
    children: [shouldRenderGuards && (0, import_jsx_runtime36.jsx)(FocusGuard, {
      "data-type": "inside",
    ...
    }), !isUntrappedTypeableCombobox && renderDismissButton("start"), children, renderDismissButton("end"), shouldRenderGuards && (0, import_jsx_runtime36.jsx)(FocusGuard, {
      "data-type": "inside",
...
var FloatingOverlay = React44.forwardRef(function FloatingOverlay2(props, ref) {
  const {
    lockScroll = false,
    ...rest
  } = props;
...
function useClick(context2, props) {
  ...
  const pointerTypeRef = React44.useRef();
  const didKeyDownRef = React44.useRef(false);
  const reference = React44.useMemo(() => ({
    onPointerDown(event) {
      pointerTypeRef.current = event.pointerType;
    },
...
function useDismiss(context2, props) {
  ...
  const endedOrStartedInsideRef = React44.useRef(false);
  const {
  ...
  const isComposingRef = React44.useRef(false);
...
function useFloatingRootContext(options) {
  ...
  const dataRef = React44.useRef({});
  const [events] = React44.useState(() => createEventEmitter());
  ...
  const [positionReference, setPositionReference] = React44.useState(elementsProp.reference);
...
function useFloating3(options) {
  ...
  const [_domReference, setDomReference] = React44.useState(null);
  const [positionReference, _setPositionReference] = React44.useState(null);
  ...
  const context2 = React44.useMemo(() => ({
    ...position,
    ...rootContext,
    refs,
    elements,
...
function useFocus(context2, props) {
  ...
  const blockFocusRef = React44.useRef(false);
  const timeoutRef = React44.useRef(-1);
  const keyboardModalityRef = React44.useRef(true);
  React44.useEffect(() => {
    if (!enabled) return;
...
function useListNavigation(context2, props) {
  ...
  const focusItemOnOpenRef = React44.useRef(focusItemOnOpen);
  const indexRef = React44.useRef(selectedIndex != null ? selectedIndex : -1);
  const keyRef = React44.useRef(null);
  const isPointerModalityRef = React44.useRef(true);
  const previousOnNavigateRef = React44.useRef(onNavigate);
  const previousMountedRef = React44.useRef(!!elements.floating);
  ...
  const [activeId, setActiveId] = React44.useState();
  const [virtualId, setVirtualId] = React44.useState();
  ...
  const getParentOrientation = React44.useCallback(() => {
    var _tree$nodesRef$curren;
...
function useRole(context2, props) {
  ...
  const floatingId = React44.useMemo(() => {
...
function useTypeahead(context2, props) {
  ...
  const timeoutIdRef = React44.useRef(-1);
  const stringRef = React44.useRef("");
  const prevIndexRef = React44.useRef((_ref = selectedIndex != null ? selectedIndex : activeIndex) != null ? _ref : -1);
...
function useInnerOffset(context2, props) {
  ...
  const controlledScrollingRef = React44.useRef(false);
  const prevScrollTopRef = React44.useRef(null);
  const initialOverflowRef = React44.useRef(null);
  React44.useEffect(() => {
    if (!enabled) return;
    function onWheel(e) {
...
var useFloatingContext = ({
  ...
  disableFocus,
  hoverable
}) => import_react37.default.useCallback((props) => {
...
var PopoverAnchor = React46.forwardRef(function(props, forwardedRef) {
  const {
    scope,
    ...rest
  ...
  return React46.useEffect(() => (onCustomAnchorAdd(), () => onCustomAnchorRemove()), [onCustomAnchorAdd, onCustomAnchorRemove]), (0, import_jsx_runtime37.jsx)(PopperAnchor, {
    scope,
    ...rest,
    ref: forwardedRef
  });
});
var PopoverTrigger = React46.forwardRef(function(props, forwardedRef) {
  const {
    scope,
    ...rest
  ...
  const trigger = (0, import_jsx_runtime37.jsx)(View, {
    "aria-expanded": context2.open,
    "data-state": getState5(context2.open),
    ...rest,
    ref: composedTriggerRef,
    onPress: composeEventHandlers(props.onPress, context2.onOpenToggle)
  }), virtualRef = React46.useMemo(() => anchorTo ? {
    current: {
  ...
  return context2.hasCustomAnchor ? trigger : (0, import_jsx_runtime37.jsx)(PopperAnchor, {
    ...virtualRef && {
      virtualRef
    },
    scope,
...
var PopoverContentFrame = styled(PopperContentFrame, {
  name: "Popover"
});
var PopoverContent = PopoverContentFrame.extractable(React46.forwardRef(function(props, forwardedRef) {
  const {
    trapFocus,
    ...
    scope,
    ...contentImplProps
  } = props, context2 = usePopoverContext(scope), contentRef = React46.useRef(null), composedRefs = useComposedRefs(forwardedRef, contentRef), isRightClickOutsideRef = React46.useRef(false), [isFullyHidden, setIsFullyHidden] = React46.useState(!context2.open);
  return React46.useEffect(() => {
    context2.open && isFullyHidden && setIsFullyHidden(false);
  }, [context2.open, isFullyHidden]), !context2.keepChildrenMounted && isFullyHidden && !context2.open ? null : (0, import_jsx_runtime37.jsx)(PopoverPortal, {
    passThrough: context2.breakpointActive,
    context: context2,
    zIndex,
    children: (0, import_jsx_runtime37.jsx)(Stack2, {
      passThrough: context2.breakpointActive,
      pointerEvents: context2.open ? contentImplProps.pointerEvents ?? "auto" : "none",
      children: (0, import_jsx_runtime37.jsx)(PopoverContentImpl, {
        ...contentImplProps,
        context: context2,
        enableRemoveScroll,
        ref: composedRefs,
...
function RepropagateParentContexts({
  ...
  return (0, import_jsx_runtime37.jsx)(PopperProvider, {
    scope: context2.popoverScope,
    ...popperContext,
    children: (0, import_jsx_runtime37.jsx)(PopoverContext.Provider, {
      ...context2,
      children: (0, import_jsx_runtime37.jsx)(ProvideAdaptContext, {
        ...adaptContext,
        children
      })
    })
...
var PortalAdaptSafe = ({
  ...
  if (needsRepropagation2) {
    ...
    return (0, import_jsx_runtime37.jsx)(AdaptPortalContents, {
      scope: context2.adaptScope,
      children: (0, import_jsx_runtime37.jsx)(RepropagateParentContexts, {
        ...parentContexts,
        children
      })
    });
...
function PopoverPortal({
  ...
  if (needsRepropagation2) {
    const parentContexts = useParentContexts(context2.popoverScope);
    content = (0, import_jsx_runtime37.jsx)(RepropagateParentContexts, {
      ...parentContexts,
      children: content
    });
  }
  return (0, import_jsx_runtime37.jsx)(Portal, {
    ...
    stackZIndex: true,
    zIndex,
    children: (0, import_jsx_runtime37.jsxs)(Theme, {
      passThrough,
      contain: true,
      forceClassName: true,
      name: themeName,
      children: [!!context2.open && !context2.breakpointActive && (0, import_jsx_runtime37.jsx)(YStack, {
        fullscreen: true,
        onPress: composeEventHandlers(onPress, context2.onOpenToggle)
      }), (0, import_jsx_runtime37.jsx)(StackZIndexContext, {
        zIndex: resolveViewZIndex(zIndex),
        children: content
      })]
    })
...
var PopoverContentImpl = React46.forwardRef(function(props, forwardedRef) {
  const {
    trapFocus,
    scope,
    onOpenAutoFocus,
    ...
    open,
    keepChildrenMounted
  } = context2, handleExitComplete = React46.useCallback(() => {
    setIsFullyHidden?.(true);
  }, [setIsFullyHidden]);
  let contents = (0, import_jsx_runtime37.jsx)(ResetPresence, {
    disable: context2.breakpointActive,
    children
  });
  return context2.breakpointActive || (contents = (0, import_jsx_runtime37.jsx)(RemoveScroll, {
    enabled: context2.breakpointActive ? false : enableRemoveScroll ? open : false,
    children: (0, import_jsx_runtime37.jsx)(FocusScope, {
    ...
    lazyMount,
    passThrough: context2.breakpointActive,
    children: (0, import_jsx_runtime37.jsx)(PopperContent, {
      scope,
      ...
      passThrough: context2.breakpointActive,
      ...contentProps,
      children: (0, import_jsx_runtime37.jsx)(PortalAdaptSafe, {
        context: context2,
        children: contents
      })
    }, context2.contentId)
...
var PopoverClose = React46.forwardRef(function(props, forwardedRef) {
  const {
    scope,
    ...rest
  } = props, context2 = usePopoverContext(scope);
  return (0, import_jsx_runtime37.jsx)(YStack, {
    ...rest,
    ref: forwardedRef,
...
var PopoverArrow = PopperArrowFrame.styleable(function(props, forwardedRef) {
  ...
  return useAdaptIsActive(context2.adaptScope) ? null : (0, import_jsx_runtime37.jsx)(PopperArrow, {
    scope,
...
var PopoverScrollView = React46.forwardRef(({
  scope,
  ...props
}, ref) => {
  const context2 = usePopoverContext(scope);
  return (0, import_jsx_runtime37.jsx)(ScrollView, {
    ref,
...
var DEFAULT_SCOPE = "";
var Popover = withStaticProperties(React46.forwardRef(function({
  scope = DEFAULT_SCOPE,
  ...props
}, ref) {
  const id = React46.useId(), adaptScope = `PopoverAdapt${scope}`;
  return (0, import_jsx_runtime37.jsx)(AdaptParent, {
    scope: adaptScope,
    portal: true,
    children: (0, import_jsx_runtime37.jsx)(PopoverInner, {
      adaptScope,
      ref,
      id,
      scope,
...
var PopoverInner = React46.forwardRef(function(props, forwardedRef) {
  const {
    children,
    open: openProp,
    defaultOpen,
    ...
    adaptScope,
    ...restProps
  } = props, triggerRef = React46.useRef(null), [hasCustomAnchor, setHasCustomAnchor] = React46.useState(false), viaRef = React46.useRef(void 0), [keepChildrenMounted] = useControllableState({
    ...
    hoverable,
    disableFocus
  }), [anchorTo, setAnchorToRaw] = React46.useState(), setAnchorTo = useCreateShallowSetState(setAnchorToRaw);
  React46.useImperativeHandle(forwardedRef, () => ({
  ...
  const popoverContext = {
    ...
    keepChildrenMounted
  }, memoizedChildren = React46.useMemo(() => (0, import_jsx_runtime37.jsx)(PopoverContext.Provider, {
    scope,
    ...popoverContext,
    children: (0, import_jsx_runtime37.jsx)(PopoverSheetController, {
      context: popoverContext,
      onOpenChange: setOpen,
      children
    })
  }), [scope, setOpen, children, ...Object.values(popoverContext)]), contents = (0, import_jsx_runtime37.jsx)(Popper, {
    open,
    passThrough: isAdapted,
    scope,
    stayInFrame: true,
  ...
  return (0, import_jsx_runtime37.jsx)(import_jsx_runtime37.Fragment, {
    children: isWeb ? (0, import_jsx_runtime37.jsx)(FloatingOverrideContext.Provider, {
...
var PopoverSheetController = ({
  ...
  const showSheet = useShowPopoverSheet(context2), breakpointActive = context2.breakpointActive, getShowSheet = useGet(showSheet);
  return (0, import_jsx_runtime37.jsx)(SheetController, {
    onOpenChange: (val) => {
...
var ProgressIndicator = ProgressIndicatorFrame.styleable(function(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime38.jsx)(ProgressIndicatorFrame, {
...
var Progress = withStaticProperties(ProgressFrame.styleable(function(props, forwardedRef) {
  const {
    ...
    size: size4 = "$true",
    ...progressProps
  } = props, max2 = isValidMaxNumber(maxProp) ? maxProp : DEFAULT_MAX, value = isValidValueNumber(valueProp, max2) ? valueProp : null, valueLabel = isNumber(value) ? getValueLabel(value, max2) : void 0, [width, setWidth] = React47.useState(0);
  return (0, import_jsx_runtime38.jsx)(ProgressProvider, {
    scope: __scopeProgress,
    value,
    max: max2,
    width,
    children: (0, import_jsx_runtime38.jsx)(ProgressFrame, {
      "aria-valuemax": max2,
      "aria-valuemin": 0,
...
var BubbleInput2 = (props) => {
  const {
    ...
    accentColor,
    ...inputProps
  } = props, ref = import_react39.default.useRef(null), prevChecked = usePrevious(checked);
  ...
  }, [prevChecked, checked, bubbles]), (0, import_jsx_runtime39.jsx)("input", {
    type: "radio",
...
var useRadioGroupItem = (params) => {
  const {
    ...
    native,
    accentColor
  } = (0, import_react40.useContext)(radioGroupContext), [button, setButton] = (0, import_react40.useState)(null), hasConsumerStoppedPropagationRef = (0, import_react40.useRef)(false), ref = (0, import_react40.useRef)(null), composedRefs = useComposedRefs(refProp, (node) => setButton(node), ref), isArrowKeyPressedRef = (0, import_react40.useRef)(false), isFormControl = isWeb ? button ? !!button.closest("form") : true : false, checked = groupValue === value, labelId = useLabelContext(button), labelledBy = ariaLabelledby || labelId;
  ...
  return {
    ...
    checked,
    isFormControl,
    bubbleInput: (0, import_jsx_runtime40.jsx)(BubbleInput2, {
      isHidden: !native,
      control: button,
      bubbles: !hasConsumerStoppedPropagationRef.current,
      name,
...
function useRadioGroupItemIndicator(params) {
  const {
    ...
    checked
  } = (0, import_react40.useContext)(radioGroupItemContext);
  return {
    checked,
    "data-state": getState6(checked),
    "data-disabled": disabled ? "" : void 0,
...
var RovingFocusGroupImpl = React49.forwardRef((props, forwardedRef) => {
  const {
    ...
    onEntryFocus,
    ...groupProps
  } = props, ref = React49.useRef(null), composedRefs = useComposedRefs(forwardedRef, ref), direction = useDirection(dir), [currentTabStopId = null, setCurrentTabStopId] = useControllableState({
    prop: currentTabStopIdProp,
    defaultProp: defaultCurrentTabStopId ?? null,
    onChange: onCurrentTabStopIdChange
  }), [isTabbingBackOut, setIsTabbingBackOut] = React49.useState(false), handleEntryFocus = useEvent(onEntryFocus), getItems = useCollection2(__scopeRovingFocusGroup || ROVING_FOCUS_GROUP_CONTEXT), isClickFocusRef = React49.useRef(false), [focusableItemsCount, setFocusableItemsCount] = React49.useState(0);
  ...
  }, [handleEntryFocus]), (0, import_jsx_runtime41.jsx)(RovingFocusProvider, {
    scope: __scopeRovingFocusGroup,
    orientation,
    dir: direction,
    loop,
    currentTabStopId,
    onItemFocus: React49.useCallback((tabStopId) => setCurrentTabStopId(tabStopId), [setCurrentTabStopId]),
    onItemShiftTab: React49.useCallback(() => setIsTabbingBackOut(true), []),
    onFocusableItemAdd: React49.useCallback(() => setFocusableItemsCount((prevCount) => prevCount + 1), []),
    onFocusableItemRemove: React49.useCallback(() => setFocusableItemsCount((prevCount) => prevCount - 1), []),
    children: (0, import_jsx_runtime41.jsx)(Stack2, {
...
var RovingFocusGroupItem = React49.forwardRef((props, forwardedRef) => {
  const {
    __scopeRovingFocusGroup,
    ...
    tabStopId,
    ...itemProps
  } = props, autoId = React49.useId(), id = tabStopId || autoId, context2 = useRovingFocusContext(__scopeRovingFocusGroup), isCurrentTabStop = context2.currentTabStopId === id, getItems = useCollection2(__scopeRovingFocusGroup || ROVING_FOCUS_GROUP_CONTEXT), {
    onFocusableItemAdd,
    onFocusableItemRemove
  } = context2;
  return React49.useEffect(() => {
    if (focusable3) return onFocusableItemAdd(), () => onFocusableItemRemove();
  }, [focusable3, onFocusableItemAdd, onFocusableItemRemove]), (0, import_jsx_runtime41.jsx)(Collection2.ItemSlot, {
    ...
    children: (0, import_jsx_runtime41.jsx)(Stack2, {
      ...
      onMouseDown: composeEventHandlers(props.onMouseDown, (event) => {
        focusable3 ? context2.onItemFocus(id) : event.preventDefault();
      }),
...
var RovingFocusGroup = withStaticProperties(React49.forwardRef((props, forwardedRef) => (0, import_jsx_runtime41.jsx)(Collection2.Provider, {
  scope: props.__scopeRovingFocusGroup || ROVING_FOCUS_GROUP_CONTEXT,
  children: (0, import_jsx_runtime41.jsx)(Collection2.Slot, {
    scope: props.__scopeRovingFocusGroup || ROVING_FOCUS_GROUP_CONTEXT,
    children: (0, import_jsx_runtime41.jsx)(RovingFocusGroupImpl, {
      ...props,
      ref: forwardedRef
    })
  })
...
function createRadioGroup(createProps) {
  ...
  const RadioGroupImp = Frame2.styleable((props, ref) => {
    ...
    return (0, import_jsx_runtime42.jsx)(RadioGroupContext.Provider, {
      value: providerValue,
      children: (0, import_jsx_runtime42.jsx)(RovingFocusGroup, {
        ...rovingFocusGroupAttrs,
        children: (0, import_jsx_runtime42.jsx)(RadioGroupFrame, {
          ...frameAttrs,
          ref,
          ...rest
        })
    ...
    return (0, import_jsx_runtime42.jsx)(RadioGroupItemContext.Provider, {
      value: providerValue,
      children: isWeb && native ? bubbleInput : (0, import_jsx_runtime42.jsxs)(import_jsx_runtime42.Fragment, {
        children: [(0, import_jsx_runtime42.jsx)(RovingFocusGroup.Item, {
          ...rovingFocusGroupAttrs,
          children: (0, import_jsx_runtime42.jsx)(RadioGroupItemFrame, {
            ...frameAttrs,
            ref,
            ...rest
          })
  ...
  const RadioIndicator = Indicator.styleable((props, forwardedRef) => {
    ...
    return forceMount || checked ? (0, import_jsx_runtime42.jsx)(Indicator, {
      ...useIndicatorRest,
      ref: forwardedRef,
      ...indicatorProps
    }) : null;
...
function useDebounce(fn, wait, options = defaultOpts, mountArgs = [fn]) {
  const dbEffect = React51.useRef(null);
  return React51.useEffect(() => () => {
    dbEffect.current?.cancel();
  }, []), React51.useMemo(() => (dbEffect.current = debounce(fn, wait, options.leading), dbEffect.current), [options.leading, ...mountArgs]);
}
function useDebounceValue(val, amt = 0) {
  const [state, setState] = React51.useState(val);
  return React51.useEffect(() => {
    const tm = setTimeout(() => {
...
var ForwardSelectContext = ({
  ...
  itemContext,
  children
}) => (0, import_jsx_runtime43.jsx)(SelectProvider, {
  isInSheet: true,
...
var SelectContent = ({
  ...
  const context2 = useSelectContext(scope), itemParentContext = useSelectItemParentContext(scope), themeName = useThemeName(), showSheet = useShowSelectSheet(context2), contents = (0, import_jsx_runtime44.jsx)(Theme, {
    forceClassName: true,
    name: themeName,
    children
  }), touch = useIsTouchDevice(), overlayStyle = import_react43.default.useMemo(() => ({
    zIndex,
    pointerEvents: context2.open ? "auto" : "none"
  }), [context2.open]);
  return itemParentContext.shouldRenderWebNative ? (0, import_jsx_runtime44.jsx)(import_jsx_runtime44.Fragment, {
    children
  }) : showSheet ? context2.open ? (0, import_jsx_runtime44.jsx)(import_jsx_runtime44.Fragment, {
    children: contents
  }) : null : (0, import_jsx_runtime44.jsx)(FloatingPortal, {
    children: (0, import_jsx_runtime44.jsx)(FloatingOverlay, {
      style: overlayStyle,
      lockScroll: !context2.disablePreventBodyScroll && !!context2.open && !touch,
      children: (0, import_jsx_runtime44.jsx)(FocusScope, {
        loop: true,
        enabled: !!context2.open,
        trapped: true,
        ...focusScopeProps,
...
var SelectInlineImpl = (props) => {
  const {
    ...
    setOpen,
    setSelectedIndex
  } = selectItemParentContext, [scrollTop, setScrollTop] = React53.useState(0), touch = useIsTouchDevice(), listItemsRef = React53.useRef([]), overflowRef = React53.useRef(null), upArrowRef = React53.useRef(null), downArrowRef = React53.useRef(null), allowSelectRef = React53.useRef(false), allowMouseUpRef = React53.useRef(true), selectTimeoutRef = React53.useRef(null), state = React53.useRef({
    isMouseOutside: false,
    isTyping: false
  }), [controlledScrolling, setControlledScrolling] = React53.useState(false), [fallback, setFallback] = React53.useState(false), [innerOffset, setInnerOffset] = React53.useState(0), [blockSelection, setBlockSelection] = React53.useState(false), floatingStyle = React53.useRef({});
  useIsomorphicLayoutEffect(() => {
    queueMicrotask(() => {
  ...
  const onMatch = useEvent((index3) => (open ? setActiveIndex : setSelectedIndex)(index3)), interactionsProps = [useClick(context2, {
    ...
    React53.useMemo(() => interactionsProps, interactionsProps)
  ), interactionsContext = React53.useMemo(() => ({
    ...interactions,
    getReferenceProps() {
  ...
  return useIsomorphicLayoutEffect(() => {
  ...
  }, [refs, fallback]), (0, import_jsx_runtime45.jsx)(SelectProvider, {
    scope,
    ...selectContext,
    setScrollTop,
    setInnerOffset,
    ...
    downArrowRef,
    update,
    children: (0, import_jsx_runtime45.jsx)(SelectItemParentProvider, {
      scope,
...
} = createStyledContext(null, ITEM_NAME3);
var SelectItem = ListItemFrame.styleable(function(props, forwardedRef) {
  ...
  } = context2, [isSelected, setSelected] = React54.useState(initialValue2 === value);
  React54.useEffect(() => activeIndexSubscribe((i) => {
    index3 === i && (onActiveChange(value, index3), listRef?.current[index3]?.focus());
  }), [index3]), React54.useEffect(() => valueSubscribe((val) => {
    setSelected(val === value);
  }), [value]);
  const textId = React54.useId(), refCallback = React54.useCallback((node) => {
  ...
  return (0, import_jsx_runtime46.jsx)(SelectItemContextProvider, {
    scope,
    value,
    textId: textId || "",
    isSelected,
    children: shouldRenderWebNative ? (0, import_jsx_runtime46.jsx)("option", {
      value,
      children: props.children
    }) : (0, import_jsx_runtime46.jsx)(ListItemFrame, {
      tag: "div",
...
var SelectItemTextFrame = styled(SizableText2, {
  name: ITEM_TEXT_NAME,
  variants: {
    unstyled: {
      false: {
...
var SelectItemText = SelectItemTextFrame.styleable(function(props, forwardedRef) {
  const {
    ...
    className,
    ...itemTextProps
  } = props, context2 = useSelectContext(scope), itemParentContext = useSelectItemParentContext(scope), ref = React55.useRef(null), composedRefs = useComposedRefs(forwardedRef, ref), itemContext = useSelectItemContext(scope), contents = React55.useRef(null);
  return contents.current = (0, import_jsx_runtime47.jsx)(SelectItemTextFrame, {
    className,
  ...
  }), [itemContext.value]), itemParentContext.shouldRenderWebNative ? (0, import_jsx_runtime47.jsx)(import_jsx_runtime47.Fragment, {
    children: props.children
  }) : (0, import_jsx_runtime47.jsx)(import_jsx_runtime47.Fragment, {
...
var SelectScrollUpButton = React56.forwardRef((props, forwardedRef) => (0, import_jsx_runtime48.jsx)(SelectScrollButtonImpl, {
...
var SelectScrollDownButton = React56.forwardRef((props, forwardedRef) => (0, import_jsx_runtime48.jsx)(SelectScrollButtonImpl, {
...
var SelectScrollButtonImpl = React56.memo(React56.forwardRef((props, forwardedRef) => {
  const {
    scope,
    dir,
    componentName,
    ...
    setInnerOffset,
    ...context2
  } = useSelectContext(scope), floatingRef = context2.floatingContext?.refs.floating, statusRef = React56.useRef("idle"), isVisible = context2[dir === "down" ? "canScrollDown" : "canScrollUp"], frameRef = React56.useRef(null), {
    x,
    y,
    refs,
    strategy
  ...
  return (0, import_jsx_runtime48.jsx)(YStack, {
    ref: composedRef,
    componentName,
    "aria-hidden": true,
    ...scrollIndicatorProps,
...
var SelectTrigger = React57.forwardRef(function(props, forwardedRef) {
  const {
    scope,
    disabled = false,
    unstyled = false,
  ...
  return itemParentContext.shouldRenderWebNative ? null : (0, import_jsx_runtime49.jsx)(ListItem2, {
...
var SelectViewport = SelectViewportFrame.styleable(function(props, forwardedRef) {
  ...
  }, [isAdapted]), itemContext.shouldRenderWebNative) return (0, import_jsx_runtime50.jsx)(import_jsx_runtime50.Fragment, {
    children
  });
  if (isAdapted || !isWeb) {
    let content = children;
    return needsRepropagation3 && (content = (0, import_jsx_runtime50.jsx)(ForwardSelectContext, {
      itemContext,
      context: context2,
      children: content
    })), (0, import_jsx_runtime50.jsx)(AdaptPortalContents, {
      scope: context2.adaptScope,
      children: content
    });
  }
  ...
  return (0, import_jsx_runtime50.jsxs)(import_jsx_runtime50.Fragment, {
    children: [!disableScroll && !props.unstyled && (0, import_jsx_runtime50.jsx)("style", {
      dangerouslySetInnerHTML: {
        __html: selectViewportCSS
      }
    }), (0, import_jsx_runtime50.jsx)(AnimatePresence, {
      children: context2.open ? (0, import_jsx_runtime50.jsx)(FloatingFocusManager, {
        context: context2.floatingContext,
        modal: false,
        children: (0, import_jsx_runtime50.jsx)(SelectViewportFrame, {
    ...
    }), !context2.open && (0, import_jsx_runtime50.jsx)("div", {
      style: {
        display: "none"
      },
      children: props.children
...
var SelectValueFrame = styled(SizableText2, {
  name: VALUE_NAME,
  userSelect: "none"
});
var SelectValue = SelectValueFrame.styleable(function({
  ...
  return (0, import_jsx_runtime51.jsx)(SelectValueFrame, {
    ...!props.unstyled && {
      size: itemParentContext.size,
      ellipse: true,
...
function unwrapSelectItem(selectValueChildren) {
  return React58.Children.map(selectValueChildren, (child) => {
    if (child) {
...
var SelectIcon = styled(XStack, {
  ...
  // @ts-ignore
  "aria-hidden": true,
  children: (0, import_jsx_runtime51.jsx)(Paragraph, {
    children: "▼"
  })
});
...
var SelectItemIndicator = React58.forwardRef(function(props, forwardedRef) {
  const {
    scope,
    ...itemIndicatorProps
  } = props, context2 = useSelectItemParentContext(scope), itemContext = useSelectItemContext(scope);
  return context2.shouldRenderWebNative ? null : itemContext.isSelected ? (0, import_jsx_runtime51.jsx)(SelectItemIndicatorFrame, {
    "aria-hidden": true,
    ...itemIndicatorProps,
    ref: forwardedRef
  }) : null;
...
var NativeSelectTextFrame = styled(SizableText2, {
  tag: "select",
  backgroundColor: "$background",
  borderColor: "$borderColor",
  hoverStyle: {
...
var SelectGroup = React58.forwardRef((props, forwardedRef) => {
  const {
    scope,
    ...groupProps
  } = props, groupId = React58.useId(), context2 = useSelectContext(scope), itemParentContext = useSelectItemParentContext(scope), size4 = itemParentContext.size ?? "$true", nativeSelectRef = React58.useRef(null), content = itemParentContext.shouldRenderWebNative ? (0, import_jsx_runtime51.jsx)(NativeSelectFrame, {
    asChild: true,
    size: size4,
    value: context2.value,
    id: itemParentContext.id,
    children: (0, import_jsx_runtime51.jsx)(NativeSelectTextFrame, {
      onChange: (event) => {
  ...
  }) : (0, import_jsx_runtime51.jsx)(SelectGroupFrame, {
    role: "group",
    "aria-labelledby": groupId,
    ...groupProps,
    ref: forwardedRef
  });
  return (0, import_jsx_runtime51.jsx)(SelectGroupContextProvider, {
    scope,
    id: groupId || "",
    children: content
  });
...
var SelectLabel = React58.forwardRef((props, forwardedRef) => {
  const {
    scope,
    ...labelProps
  } = props, context2 = useSelectItemParentContext(scope), groupContext = useSelectGroupContext(scope);
  return context2.shouldRenderWebNative ? null : (0, import_jsx_runtime51.jsx)(ListItem2, {
    tag: "div",
...
var SelectSheetController = (props) => {
  const context2 = useSelectContext(props.scope), showSheet = useShowSelectSheet(context2), isAdapted = useAdaptIsActive(context2.adaptScope), getShowSheet = useGet(showSheet);
  return (0, import_jsx_runtime51.jsx)(SheetController, {
    onOpenChange: (val) => {
      getShowSheet() && props.onOpenChange(val);
    },
    open: context2.open,
...
var SelectSheetImpl = (props) => (0, import_jsx_runtime51.jsx)(import_jsx_runtime51.Fragment, {
  children: props.children
});
var Select = withStaticProperties(function(props) {
  const adaptScope = `AdaptSelect${props.scope || ""}`;
  return (0, import_jsx_runtime51.jsx)(AdaptParent, {
    scope: adaptScope,
    portal: true,
    children: (0, import_jsx_runtime51.jsx)(SelectInner, {
      scope: props.scope,
      adaptScope,
      ...props
    })
...
function useEmitter() {
  const listeners = React58.useRef(null);
  listeners.current || (listeners.current = /* @__PURE__ */ new Set());
  const emit = (value) => {
    listeners.current.forEach((l) => l(value));
  }, subscribe2 = React58.useCallback((listener) => (listeners.current.add(listener), () => {
...
function SelectInner(props) {
  const {
    ...
    id,
    renderValue
  } = props, SelectImpl = useAdaptIsActive(adaptScope) || !isWeb ? SelectSheetImpl : SelectInlineImpl, forceUpdate = React58.useReducer(() => ({}), {})[1], [selectedItem, setSelectedItem] = React58.useState(null), [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen || false,
    onChange: onOpenChange
  ...
  }, [open]), React58.useEffect(() => {
    emitValue(value);
  }, [value]);
  const [activeIndex, setActiveIndex] = React58.useState(0), [emitValue, valueSubscribe] = useEmitter(), [emitActiveIndex, activeIndexSubscribe] = useEmitter(), selectedIndexRef = React58.useRef(null), activeIndexRef = React58.useRef(null), listContentRef = React58.useRef([]), [selectedIndex, setSelectedIndex] = React58.useState(0), [valueNode, setValueNode] = React58.useState(null);
  useIsomorphicLayoutEffect(() => {
  ...
  return (0, import_jsx_runtime51.jsx)(SelectItemParentProvider, {
    scopeName: scope,
    scope,
    adaptScope,
    initialValue: React58.useMemo(() => value, [open]),
    size: sizeProp,
    activeIndexSubscribe,
    valueSubscribe,
    setOpen,
    id,
    onChange: React58.useCallback((val) => {
      setValue(val), emitValue(val);
    }, []),
    onActiveChange: useEvent((value2, index3) => {
      onActiveChange?.(value2, index3);
    }),
    setSelectedIndex,
    setValueAtIndex: React58.useCallback((index3, value2) => {
    ...
    children: (0, import_jsx_runtime51.jsx)(SelectProvider, {
      ...
      native,
      renderValue,
      children: (0, import_jsx_runtime51.jsx)(SelectSheetController, {
        onOpenChange: setOpen,
        scope,
        children: shouldRenderWebNative ? children : (0, import_jsx_runtime51.jsx)(SelectImpl, {
          activeIndexRef,
          listContentRef,
          selectedIndexRef,
          ...props,
...
var SliderContext = createStyledContext({
  size: "$true",
  min: 0,
  max: 100,
  orientation: "horizontal"
...
function getThumbInBoundsOffset(width, left, direction) {
  ...
  return (quarterWidth - offset4(left)) * direction;
}
...
var SliderImpl = React59.forwardRef((props, forwardedRef) => {
  const {
    __scopeSlider,
    onSlideStart,
    onSlideMove,
  ...
  return (0, import_jsx_runtime52.jsx)(SliderFrame, {
    size: "$4",
    ...sliderProps,
...
var SliderHorizontal = React60.forwardRef((props, forwardedRef) => {
  const {
    min: min2,
    max: max2,
    dir,
    ...
    onSlideEnd,
    ...sliderProps
  } = props, direction = useDirection(dir), isDirectionLTR = direction === "ltr", sliderRef = React60.useRef(null), [state, setState_] = React60.useState(() => ({
    size: 0,
    offset: 0
  ...
  return isClient && (useOnDebouncedWindowResize(measure), React60.useEffect(() => {
  ...
  }, [])), (0, import_jsx_runtime53.jsx)(SliderOrientationProvider, {
    ...
    sizeProp: "width",
    size: state.size,
    children: (0, import_jsx_runtime53.jsx)(SliderImpl, {
...
var SliderVertical = React60.forwardRef((props, forwardedRef) => {
  const {
    min: min2,
    max: max2,
    onSlideStart,
    ...
    onSlideEnd,
    ...sliderProps
  } = props, [state, setState_] = React60.useState(() => ({
    size: 0,
    offset: 0
  })), setState = useCreateShallowSetState(setState_), sliderRef = React60.useRef(null);
  function getValueFromPointer(pointerPosition) {
    const input = [0, state.size];
  ...
  return isClient && useOnDebouncedWindowResize(measure), (0, import_jsx_runtime53.jsx)(SliderOrientationProvider, {
    scope: props.__scopeSlider,
    startEdge: "bottom",
    endEdge: "top",
    sizeProp: "height",
...
var SliderTrack = React60.forwardRef((props, forwardedRef) => {
  const {
    __scopeSlider,
    ...trackProps
  } = props, context2 = useSliderContext(__scopeSlider);
  return (0, import_jsx_runtime53.jsx)(SliderTrackFrame, {
    "data-disabled": context2.disabled ? "" : void 0,
    "data-orientation": context2.orientation,
...
var SliderThumb = SliderThumbFrame.styleable(function(props, forwardedRef) {
  const {
    ...
    size: sizeProp,
    ...thumbProps
  } = props, context2 = useSliderContext(__scopeSlider), orientation = useSliderOrientationContext(__scopeSlider), [thumb, setThumb] = React60.useState(null), composedRefs = useComposedRefs(forwardedRef, setThumb), value = context2.values[index3], percent = value === void 0 ? 0 : convertValueToPercentage(value, context2.min, context2.max), label = getLabel(index3, context2.values.length), sizeIn = sizeProp ?? context2.size ?? "$true", [size4, setSize] = React60.useState(() => getVariableValue(getThumbSize(sizeIn).width)), thumbInBoundsOffset = size4 ? getThumbInBoundsOffset(size4, percent, orientation.direction) : 0;
  React60.useEffect(() => {
  ...
  return (0, import_jsx_runtime53.jsx)(SliderThumbFrame, {
    ref: composedRefs,
    role: "slider",
...
var SliderComponent = React60.forwardRef((props, forwardedRef) => {
  const {
    name,
    min: min2 = 0,
    max: max2 = 100,
    ...
    onSlideStart,
    ...sliderProps
  } = props, sliderRef = React60.useRef(null), composedRefs = useComposedRefs(sliderRef, forwardedRef), thumbRefs = React60.useRef(/* @__PURE__ */ new Map()), valueIndexToChangeRef = React60.useRef(0), isHorizontal = orientation === "horizontal", [values = [], setValues] = useControllableState({
    prop: value,
    defaultProp: defaultValue,
    transition: true,
    onChange: (value2) => {
  ...
  return (0, import_jsx_runtime53.jsx)(SliderProvider, {
    scope: props.__scopeSlider,
    disabled,
    min: min2,
    max: max2,
    ...
    orientation,
    size: sizeProp,
    children: (0, import_jsx_runtime53.jsx)(SliderOriented, {
...
var BubbleInput3 = (props) => {
  const {
    ...
    bubbles = true,
    ...inputProps
  } = props, ref = React61.useRef(null), prevChecked = usePrevious(checked);
...
function useSwitch(props, [checked, setChecked], ref) {
  {
    const {
      ...
      value,
      required
    } = props, hasConsumerStoppedPropagationRef = React61.useRef(false), [button, setButton] = React61.useState(null), composedRefs = useComposedRefs(ref, setButton), isFormControl = isWeb ? button ? !!button.closest("form") : true : false, labelId = useLabelContext(button), ariaLabelledBy = props["aria-labelledby"] || props.labeledBy || labelId;
    return {
      switchProps: {
        role: "switch",
        "aria-checked": checked,
       ...
       */
      bubbleInput: isWeb && isFormControl ? (0, import_jsx_runtime54.jsx)(BubbleInput3, {
        control: button,
        bubbles: !hasConsumerStoppedPropagationRef.current,
        name,
        value,
...
var SwitchContext = React62.createContext({
  checked: false,
  disabled: false,
  frameWidth: 0
});
function createSwitch(createProps) {
  ...
  const SwitchThumbComponent = Thumb2.styleable(function(props, forwardedRef) {
    const {
      ...
      nativeID,
      ...thumbProps
    } = props, context2 = React62.useContext(SwitchContext), {
      checked,
      disabled,
      frameWidth
      ...
      size: sizeContext
    } = styledContext, unstyled = process.env.TAMAGUI_HEADLESS === "1" ? true : unstyledProp ?? unstyledContext ?? false, size4 = sizeProp ?? sizeContext ?? "$true", initialChecked = React62.useRef(checked).current, initialWidth = getVariableValue(props.width, "size"), [thumbWidth, setThumbWidth] = React62.useState(typeof initialWidth == "number" ? initialWidth : 0), distance = frameWidth - thumbWidth, x = initialChecked ? checked ? 0 : -distance : checked ? distance : 0;
    return (0, import_jsx_runtime55.jsx)(Thumb2, {
      ref: forwardedRef,
      unstyled,
      ...unstyled === false && {
        size: size4,
    ...
    const {
      ...
      onChange: onCheckedChange,
      transition: true
    }), styledContext = React62.useContext(SwitchStyledContext.context);
    ...
    const [frameWidth, setFrameInnerWidth] = React62.useState(estimatedInitialWidth), {
      switchProps,
      bubbleInput,
      switchRef
    } = useSwitch(
    ...
    if (renderNative === "android" || renderNative === "ios") return (0, import_jsx_runtime55.jsx)(Switch_default, {
      value: checked,
      onValueChange: setChecked,
      ...nativeProps
    });
    const disabled = props.disabled, value = React62.useMemo(() => ({
      checked,
      disabled,
      frameWidth
    ...
    return (0, import_jsx_runtime55.jsxs)(SwitchContext.Provider, {
      value,
      children: [(0, import_jsx_runtime55.jsx)(Frame2, {
        ref: switchRef,
        tag: "button",
        ...isWeb && {
          type: "button"
        ...
        checked,
        disabled,
        children: (0, import_jsx_runtime55.jsx)(View_default, {
...
var DefaultTabsTabFrame = styled(ThemeableStack, {
  name: TRIGGER_NAME5,
  tag: "button",
  variants: {
    size: {
...
function createTabs(createProps) {
  const {
  ...
  } = createProps, TABS_CONTEXT = "TabsContext", TAB_LIST_NAME = "TabsList", TabsList = React63.forwardRef((props, forwardedRef) => {
    const {
      __scopeTabs,
      loop = true,
      children,
    ...
    return (0, import_jsx_runtime56.jsx)(RovingFocusGroup, {
      __scopeRovingFocusGroup: __scopeTabs || TABS_CONTEXT,
      orientation: context2.orientation,
      dir: context2.dir,
      loop,
      asChild: true,
      children: (0, import_jsx_runtime56.jsx)(Group, {
        role: "tablist",
  ...
  const TRIGGER_NAME6 = "TabsTrigger", TabsTrigger = TabFrame.styleable((props, forwardedRef) => {
    const {
      ...
      disableActiveTheme,
      ...triggerProps
    } = props, context2 = useTabsContext(__scopeTabs), triggerId = makeTriggerId(context2.baseId, value), contentId = makeContentId(context2.baseId, value), isSelected = value === context2.value, [layout, setLayout] = React63.useState(null), triggerRef = React63.useRef(null), groupItemProps = useGroupItem({
      disabled: !!disabled
    });
    return React63.useEffect(() => (context2.registerTrigger(), () => context2.unregisterTrigger()), []), React63.useEffect(() => {
    ...
    }, [context2.triggersCount]), React63.useEffect(() => {
      isSelected && layout && onInteraction?.("select", layout);
    }, [isSelected, value, layout]), (0, import_jsx_runtime56.jsx)(Theme, {
      name: isSelected && !disableActiveTheme ? "active" : null,
      children: (0, import_jsx_runtime56.jsx)(RovingFocusGroup.Item, {
        __scopeRovingFocusGroup: __scopeTabs || TABS_CONTEXT,
        asChild: true,
        focusable: !disabled,
        active: isSelected,
        children: (0, import_jsx_runtime56.jsx)(TabFrame, {
          onLayout: (event) => {
  ...
  const TabsContent = ContentFrame.styleable(function(props, forwardedRef) {
    ...
    return show ? (0, import_jsx_runtime56.jsx)(ContentFrame, {
      "data-state": isSelected ? "active" : "inactive",
      "data-orientation": context2.orientation,
      role: "tabpanel",
    ...
    const {
      ...
      onChange: onValueChange,
      defaultProp: defaultValue ?? ""
    }), [triggersCount, setTriggersCount] = React63.useState(0), registerTrigger = useEvent(() => setTriggersCount((v) => v + 1)), unregisterTrigger = useEvent(() => setTriggersCount((v) => v - 1));
    return (0, import_jsx_runtime56.jsx)(TabsProvider, {
      scope: __scopeTabs,
      baseId: React63.useId(),
      value,
      onChange: setValue,
      orientation,
      dir: direction,
      ...
      triggersCount,
      unregisterTrigger,
      children: (0, import_jsx_runtime56.jsx)(TabsFrame, {
        direction,
        "data-orientation": orientation,
        ...tabsProps,
        ref: forwardedRef
...
var Toggle = React64.forwardRef(function(props, forwardedRef) {
  const {
    pressed: pressedProp,
  ...
  return (0, import_jsx_runtime57.jsx)(ToggleFrame, {
    ...!props.unstyled && {
...
var ToggleGroupItem = ToggleFrame.styleable((props, forwardedRef) => {
  const valueContext = useToggleGroupValueContext(props.__scopeToggleGroup), context2 = useToggleGroupContext(props.__scopeToggleGroup), toggleContext = context.useStyledContext(props.__scopeToggleGroup), pressed = valueContext?.value.includes(props.value), toggledStyle = props.toggledStyle || toggleContext.toggledStyle, color = props.color || toggleContext.color, {
    disablePassStyles,
    toggledStyle: _,
    ...rest
  } = props, disabled = context2.disabled || props.disabled || false, groupItemProps = useGroupItem({
    disabled
  }), size4 = props.size ?? context2.size, sizeProps = props.unstyled ? {} : {
    width: void 0,
    height: void 0,
    padding: getVariableValue(size4) * 0.6
  }, iconSize = (typeof size4 == "number" ? size4 * 0.7 : getFontSize(size4)) * 1.2, theme = useTheme(), toggledColor = toggledStyle?.color, getThemedIcon = useGetThemedIcon({
    size: iconSize,
    color: (pressed && toggledColor ? toggledColor : color) || theme.color
  }), children = import_react47.default.Children.toArray(props.children).map((child) => props.disablePassStyles || !import_react47.default.isValidElement(child) ? child : import_react47.default.cloneElement(getThemedIcon(child), {
    active: pressed
  })), commonProps = {
    pressed,
    disabled,
    ...
    ...rest,
    children
  }, inner2 = (0, import_jsx_runtime58.jsx)(ToggleGroupItemImpl, {
    ...commonProps,
    ref: forwardedRef,
  ...
  return (0, import_jsx_runtime58.jsx)(ToggleGroupItemProvider, {
    scope: props.__scopeToggleGroup,
    children: (0, import_jsx_runtime58.jsx)(context.Provider, {
      color,
      toggledStyle,
      children: context2.rovingFocus ? (0, import_jsx_runtime58.jsx)(RovingFocusGroup.Item, {
...
var ToggleGroupItemImpl = import_react47.default.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime58.jsx)(Toggle, {
    ...typeProps,
    ...itemProps,
    ref: forwardedRef,
...
var ToggleGroup = withStaticProperties(import_react47.default.forwardRef((props, forwardedRef) => {
  ...
  }, [props.id]), type === "single") return (0, import_jsx_runtime58.jsx)(ToggleGroupImplSingle, {
    ...toggleGroupProps,
    ref: forwardedRef
  });
  if (type === "multiple") return (0, import_jsx_runtime58.jsx)(ToggleGroupImplMultiple, {
    ...toggleGroupProps,
    ref: forwardedRef
  });
...
var ToggleGroupImplSingle = import_react47.default.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime58.jsx)(ToggleGroupValueProvider, {
    scope: props.__scopeToggleGroup,
    type: "single",
    value: value ? [value] : [],
    defaultValue: value,
    ...
    children: (0, import_jsx_runtime58.jsx)(ToggleGroupImpl, {
      ...toggleGroupSingleProps,
      ref: forwardedRef
    })
  });
...
var ToggleGroupImpl = ToggleGroupImplElementFrame.styleable((props, forwardedRef) => {
  const {
    __scopeToggleGroup,
    disabled = false,
    orientation = "horizontal",
  ...
  return (0, import_jsx_runtime58.jsx)(ToggleGroupContext, {
    ...
    children: (0, import_jsx_runtime58.jsx)(context.Provider, {
      color,
      toggledStyle,
      children: rovingFocus ? (0, import_jsx_runtime58.jsx)(RovingFocusGroup, {
        asChild: "except-style",
        __scopeRovingFocusGroup: __scopeToggleGroup || TOGGLE_GROUP_CONTEXT,
        orientation,
        dir: direction,
        loop,
        children: (0, import_jsx_runtime58.jsx)(ToggleGroupImplElementFrame, {
          "aria-orientation": orientation,
          orientation,
          ref: forwardedRef,
          "data-disabled": disabled ? "" : void 0,
      ...
      }) : (0, import_jsx_runtime58.jsx)(ToggleGroupImplElementFrame, {
        "aria-orientation": orientation,
        ref: forwardedRef,
        orientation,
        "data-disabled": disabled ? "" : void 0,
...
var TOOLTIP_SCOPE = "";
var TooltipContent = PopperContentFrame.extractable(React66.forwardRef((props, ref) => {
  const preventAnimation = React66.useContext(PreventTooltipAnimationContext);
  return (0, import_jsx_runtime59.jsx)(PopoverContent, {
...
var TooltipArrow = React66.forwardRef((props, ref) => (0, import_jsx_runtime59.jsx)(PopoverArrow, {
  scope: props.scope || TOOLTIP_SCOPE,
  componentName: "Tooltip",
  ref,
  ...props
}));
var PreventTooltipAnimationContext = React66.createContext(false);
var TooltipGroup = ({
  children,
  delay,
  preventAnimation = false,
  timeoutMs
}) => (0, import_jsx_runtime59.jsx)(PreventTooltipAnimationContext.Provider, {
  value: preventAnimation,
  children: (0, import_jsx_runtime59.jsx)(FloatingDelayGroup, {
    timeoutMs,
    delay: React66.useMemo(() => delay, [JSON.stringify(delay)]),
    children
  })
});
...
var TooltipComponent = React66.forwardRef(function(props, ref) {
  const {
    children,
    delay: delayProp = 400,
    ...
    scope = TOOLTIP_SCOPE,
    ...restProps
  } = props, triggerRef = React66.useRef(null), [hasCustomAnchor, setHasCustomAnchor] = React66.useState(false), {
    delay: delayGroup,
    setCurrentId
  ...
  }, useFloatingContext2 = React66.useCallback(useFloatingFn, [id, delay, open, restMs, focus2 ? JSON.stringify(focus2) : 0]), onCustomAnchorAdd = React66.useCallback(() => setHasCustomAnchor(true), []), onCustomAnchorRemove = React66.useCallback(() => setHasCustomAnchor(false), []), contentId = React66.useId(), smallerSize = props.unstyled ? null : getSize("$true", {
    shift: -2,
    bounds: [0]
  });
  return (
    // TODO: FloatingOverrideContext might also need to be scoped
    (0, import_jsx_runtime59.jsx)(FloatingOverrideContext.Provider, {
      value: useFloatingContext2,
      children: (0, import_jsx_runtime59.jsx)(Popper, {
        scope,
        ...
        open,
        ...restProps,
        children: (0, import_jsx_runtime59.jsx)(PopoverContext.Provider, {
          popoverScope: scope,
          scope,
          contentId,
          triggerRef,
...
var TooltipTrigger = React66.forwardRef(function(props, ref) {
  const {
    scope,
    ...rest
  } = props;
  return (0, import_jsx_runtime59.jsx)(PopoverTrigger, {
    ...rest,
    scope: scope || TOOLTIP_SCOPE,
    ref
  });
});
var TooltipAnchor = React66.forwardRef(function(props, ref) {
  const {
    scope,
    ...rest
  } = props;
  return (0, import_jsx_runtime59.jsx)(PopoverAnchor, {
    ...rest,
    scope: scope || TOOLTIP_SCOPE,
    ref
  });
...
var TooltipSimple = React67.forwardRef(({
  label,
  children,
  contentProps,
  disabled,
  ...
  return label ? (0, import_jsx_runtime60.jsxs)(Tooltip2, {
    disableRTL: true,
    offset: 15,
    restMs: 40,
    delay: 40,
    ...
    children: [(0, import_jsx_runtime60.jsx)(Tooltip2.Trigger, {
      ...typeof label == "string" && {
        "aria-label": label
      },
      asChild: "except-style",
      children: ref && React67.isValidElement(child) ? React67.cloneElement(child, {
        ref
      }) : child
    }), (0, import_jsx_runtime60.jsxs)(Tooltip2.Content, {
      zIndex: 1e9,
      enterStyle: {
        y: -4,
        opacity: 0,
      ...
      ...contentProps,
      children: [(0, import_jsx_runtime60.jsx)(Tooltip2.Arrow, {}), (0, import_jsx_runtime60.jsx)(Paragraph, {
        size: "$3",
        children: label
      })]
    })]
...
function useWindowDimensions({
  ...
  return import_react49.default.useSyncExternalStore(subscribe, getWindowSize, () => isWeb ? serverValue : getWindowSize());
}
...
var TamaguiProvider2 = ({
  children,
  ...props
}) => (0, import_jsx_runtime61.jsx)(TamaguiProvider, {
  ...props,
  children: (0, import_jsx_runtime61.jsx)(ZIndexStackContext.Provider, {
    value: 1,
    children: (0, import_jsx_runtime61.jsx)(PortalProvider, {
      shouldAddRootHost: true,
      children
    })
  })
...
var AnchorFrame = styled(SizableText2, {
  name: "Anchor",
  tag: "a",
...
var Anchor = AnchorFrame.styleable(({
  ...
  target,
  ...props
}, ref) => (0, import_jsx_runtime62.jsx)(AnchorFrame, {
  ...props,
  ...isWeb ? {
    href,
    target
...
var Input = InputFrame.styleable((propsIn, forwardedRef) => {
  const ref = import_react50.default.useRef(null), composedRefs = useComposedRefs(forwardedRef, ref), props = useInputProps(propsIn, composedRefs);
  return (0, import_jsx_runtime63.jsx)(InputFrame, {
    ...props
  });
});
...
var Spinner = YStack.extractable(themeable(React70.forwardRef((props, ref) => {
  const {
    size: size4,
    color: colorProp,
    ...stackProps
  ...
  let color = colorProp;
  return color && color[0] === "$" && (color = variableToString(theme[color])), (0, import_jsx_runtime64.jsx)(YStack, {
    ref,
    ...stackProps,
    children: (0, import_jsx_runtime64.jsx)(ActivityIndicator_default, {
      size: size4,
      color
    })
  });
...
var TextArea = TextAreaFrame.styleable((propsIn, forwardedRef) => {
  const ref = import_react51.default.useRef(null), composedRefs = useComposedRefs(forwardedRef, ref), props = useInputProps(propsIn, composedRefs), linesProp = {
    // web uses rows now, but native not caught up :/
    [isWeb ? "rows" : "numberOfLines"]: propsIn.unstyled ? void 0 : 4
  };
  return (0, import_jsx_runtime65.jsx)(TextAreaFrame, {
    ...linesProp,
    ...props
  });
});
